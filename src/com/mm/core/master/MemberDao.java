...
public class MemberDao {
	...
	public Vector getMemberList(DataSource  datasource, int facilityId) throws Exception {
		System.out.println("In Member Master Dao getMemberList Method facilityId 03-10-2009-->"+facilityId);
			Connection con = null;
			...
			try {
				...
				String sql = DBConstant.SELECT_ALL_MEMBER_SQL;
				...
				while (rs.next()) {
					...
					bean.setPhoneNo(rs.getString("phone"));
					bean.setMobileNo(rs.getString("mobile"));
			...
			System.out.println("staffList-03092009"+staffList);
			return staffList;
		}
		...
		public MemberBean getStaffData(DataSource  datasource, int userId) throws Exception {
			System.out.println("Staff Dao 22092009-1-->"+userId);
			Connection con = null;
			PreparedStatement pStatement = null;
			ResultSet rs = null;
			MemberBean bean = new MemberBean();
			try {
				con = datasource.getConnection();
				String sql = DBConstant.SELECT_MEMBER_UPDATE_SQL;
				System.out.println("Staff Dao22092009-2-->"+sql);
				pStatement = con.prepareStatement(sql);
		...
		public void insertDetail(DataSource  datasource, MemberForm staffForm) throws Exception {
			System.out.println("In Staff Dao insertDetail Method facilityId-->"+staffForm);
			Connection con = null;
			PreparedStatement pStatement= null;
			...
			try {
				...
				System.out.println("sql in Staff Dao For Insert New1-->"+sql);
				//System.out.println("getAgencyName()-->"+staffForm.getAgencyName());
				//System.out.println("StaffName-->"+staffForm.getStaffName());
				//System.out.println("getFacility-->"+staffForm.getFacility());
				//System.out.println("Category-->"+staffForm.getStaffCategory());
				//System.out.println("SubCategory-->"+staffForm.getStaffSubCategory());
				//System.out.println("StartTime-->"+staffForm.getSalary());
				//System.out.println("EndTime-->"+staffForm.getAddress());
...
//					+ "createdby,createdon,modifiedby) " + "values (?,?,?,?,?,?,?)";
		...
		public void updateMemberDetail(DataSource  datasource, MemberForm memberForm) throws Exception {
			System.out.println("In Staff Dao updateStaffDetail Method facilityId-->"+memberForm);
			Connection con = null;
			PreparedStatement pStatement = null;
			try {
				con = datasource.getConnection();
				String sql = DBConstant.UPDATE_MEMBER_SQL;
				System.out.println("sql------------>"+sql);
				//update loginmaster set first_name=?,last_name=?,email=?,phone=?,mobile=?,address=?,zip=?,birthday=?,birthplace=?,maritalstatus,profession=? where userid=?;
				pStatement = con.prepareStatement(sql);

				pStatement.setString(1, handleNullForString(memberForm.getFirstName()));
				pStatement.setString(2, memberForm.getLastName());
				pStatement.setString(3, memberForm.getEmailId());
				pStatement.setString(4, memberForm.getPhoneNo());
				pStatement.setString(5, memberForm.getMobileNo());
				pStatement.setString(6, memberForm.getAddress());
				pStatement.setString(7, memberForm.getZip());
				pStatement.setString(8, memberForm.getBirthDay());
				pStatement.setString(9, memberForm.getBirthPlace());
				pStatement.setString(10, memberForm.getMaritalStatus());
				pStatement.setString(11, memberForm.getProfession());
				pStatement.setInt(12, memberForm.getUserId());
		...
		public void inactiveStaff(DataSource  datasource, String staffIdsArr[]) throws Exception {
			System.out.println("In Staff Dao inactiveService Method facilityId-->"+staffIdsArr[0]);
			Connection con = null;
			PreparedStatement pStatement = null;
		...
		public void insertConsumerServicemapping(DataSource  datasource, 
			...
			System.out.println("In Staff Dao insertConsumerServicemapping Method facilityId-->"+staffBean);
			Connection con = null;
			PreparedStatement pStatement = null;
			try {
				con = datasource.getConnection();
		...
		public void deleteConsumerServicemapping(DataSource  datasource, int consumerId, Connection con)
				throws Exception {
			System.out.println("In Staff Dao deleteConsumerServicemapping Method facilityId-->"+consumerId);
			PreparedStatement pStatement = null;
			try {
		...
		public void updateConsumerServicemapping(DataSource  datasource, 
				ConsumerSrvciceMappingBean staffBean) throws Exception {
			System.out.println("In Staff Dao updateConsumerServicemapping Method facilityId-->"+staffBean);
			Connection con = null;
			PreparedStatement pStatement = null;
			try {
				con = datasource.getConnection();
		...
		public void insertConsumerBillDetail(Vector dataList, Connection con)
				throws Exception {
			System.out.println("In Staff Dao insertConsumerBillDetail Method facilityId-->"+dataList);
			PreparedStatement pStatement = null;
			try {
		...
		public void insertCompoundBillDetail(DataSource  datasource, CompoundBillDetailBean bean)
				throws Exception {
			System.out.println("In Staff Dao insertCompoundBillDetail Method facilityId-->"+datasource);
			Connection con = null;
			PreparedStatement pStatement = null;
			try {
				con = datasource.getConnection();
		...
		public void updatePaymentDetails(DataSource  datasource, CompoundBillDetailBean bean)
				throws Exception {
			System.out.println("In Staff Dao updatePaymentDetails Method facilityId-->"+datasource);
			Connection con = null;
			PreparedStatement pStatement = null;
			try {
				con = datasource.getConnection();
		...
		public void getAllConsumerBill(DataSource  datasource, Date billDate, Date dueDate)
				throws Exception {
			System.out.println("In Staff Dao getAllConsumerBill Method facilityId-->"+billDate);
		...
		public void processBillDetailForConsumer(DataSource dataSource, Vector detailVec, Date todayDate,
			...
			System.out.println("In Staff Dao processBillDetailForConsumer Method facilityId-->"+todayDate);
...
*/
		...
		public void generateConsumerBills(DataSource  datasource, int facilityId, int month, int year, Date dueDate) throws Exception {
			...
			System.out.println("yaha Bhi aata hai");
