...
public class CourseForColAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		String id=indvMaster.getCatForcomp(getDataSource(request,"student"),numCourseId);
		...
		Vector CourseVec = indvMaster.getcatList(getDataSource(request,"student"),id.trim());
		System.out.println("CourseVec............ "+CourseVec);
	    String strCourse = getCourseList(numCourseId, CourseVec,numCourseId);
