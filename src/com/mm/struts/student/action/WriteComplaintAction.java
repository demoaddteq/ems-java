...
public class WriteComplaintAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) {
		...
		System.out.println("qtype------"+writeComplaintForm.getQtype());
		String qtype=writeComplaintForm.getQtype().toString().trim();
...
//		String qcat = writeComplaintForm.getQcat().toString().trim();
		String qcat = "Corporates";
		...
		if(numCatID!=-1 && category.length()>0 && numCatID!=0 )
		{
			...
			if(qcat.equalsIgnoreCase("Advertiser")){
				
				categoryName  = rootMaster.getStrCollegeCategoryName(getDataSource(request, "student"), numCatID);
			}
		...
		System.out.println("Extra Vec is "+extraVec);
	...
	//	dataVec.add(writeComplaintForm.getQtype().toString().trim());
		dataVec.add("Personal");
		dataVec.add(writeComplaintForm.getCons().toString().trim());
		//dataVec.add("1");
		dataVec.add(writeComplaintForm.getCollegeList().toString().trim());
		dataVec.add(writeComplaintForm.getStudent().toString().trim());
		
		System.out.println("datavac size in write action"+dataVec.size());
		System.out.println("datavac in write action"+dataVec);
		////System.out.println("datavac in write action"+writeComplaintForm.getQtype().toString().trim());
