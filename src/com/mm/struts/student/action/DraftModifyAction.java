...
public class DraftModifyAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if(draftVec.size()>0)
		{
			...
			////////System.out.println("draftVecdraftVecdraftVec in draftmodify action"+draftVec.elementAt(15).toString().trim());
			modifyDraftForm.setQtype(draftVec.elementAt(15).toString().trim());
			modifyDraftForm.setDealerId(String.valueOf(dealerId));
			request.setAttribute("stdModifyDraftForm", modifyDraftForm);
