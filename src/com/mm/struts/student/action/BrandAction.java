...
public class BrandAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		int numbrandId = (request.getParameter("brand")!=null) ? Integer.parseInt(request.getParameter("brand").trim()) : 8;
			Vector brandVec = indvMaster.getBrand(numCatId,getDataSource(request, "student"));
