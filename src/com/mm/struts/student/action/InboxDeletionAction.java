...
import com.mm.struts.student.form.InboxDeletionForm;
...
public class InboxDeletionAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		{
			paramVec.add(inboxs);
			result = indvMaster.updateInbox(getDataSource(request, "student"), paramVec);
		}
		...
		if(result.equalsIgnoreCase("success"))
		{
			...
			errors.clear();
			errors.add("inboxdeleteindv", new ActionMessage("indv.inbox.DeleteSuccess"));
		...
		else
		{
			ActionErrors errors = new ActionErrors();
			errors.clear();
			errors.add("inboxdeleteindv", new ActionMessage("indv.inbox.DeleteFailure"));
