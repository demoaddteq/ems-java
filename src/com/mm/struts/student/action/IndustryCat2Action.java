 ...
 */
public class IndustryCat2Action extends Action {
	/*
	 * Generated Methods
	 */
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		String industryCategory = (request.getParameter("indCategory1")!=null) ? request.getParameter("indCategory1") : "1";
		 System.out.println("industryCategory.....in std.categoryAction.2....."+industryCategory);
	...
	{
		String strResult ="<select name=\"icat2\"  class=\"input_txt_box_w130\" onchange=\"doTaskCat2(+this.value);\" >";
...
String strTemCat[] = industryCategory.split(", ");
		...
		strResult += "</select>";
		System.out.println("strResult.....in std.category2Action......"+strResult);
		return strResult;
	}
}