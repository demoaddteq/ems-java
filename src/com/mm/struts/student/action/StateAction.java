...
public class StateAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		{
			strState ="<select name=\"state\"  tabindex=\"10\"  onchange=\"retrieveMyProCityURL('city.do?country="+numCId+"&state='+this.value),showOth(,setCity();\">";;
			strState += "<option value=\"0\" Selected>Select</option>";
			strState += "<option value=\"-1\">Others</option>";
			strState += "</select>";
		}
		System.out.println("codeStrArr[0]>>>strState>>>>"+strState);
	...
	private String getStateList(int numSid, int numCId, HashMap stateList)
	{
		...
		String strResult ="<select name=\"state\"  tabindex=\"10\"  onchange=\"retrieveMyProCityURL('city.do?country="+numCId+"&state='+this.value),showOth(,setCity());\">";
