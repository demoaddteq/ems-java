...
import com.mm.struts.student.form.ModifyDraftForm;
...
public class ModifyDraftAction extends LookupDispatchAction {
	...
	public ActionForward modify(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) {
		...
		System.out.println("in modify draft");
	...
	public ActionForward submit(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) {
		...
		ModifyDraftForm modifyDraftForm = (ModifyDraftForm) form;// TODO Auto-generated method stub
		System.out.println("manoj in draft save as query");
		String status = "failure";
		String draftId = modifyDraftForm.getDraftId();
		String dealerId = modifyDraftForm.getDealerId();
		...
		////System.out.println("modifyDraftForm.getQtype() .............in submitaction"+modifyDraftForm.getQtype());
		...
		////System.out.println("entpId in modifydraft"+entpId);
		if(cu_id.equals("0"))
		{
		...
		complaintVec.add(modifyDraftForm.getQtype());		//Query type
