...
public class InboxAction extends Action {
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		int totalRow = indvMaster.getInboxCount(getDataSource(request, "student"), paramVec1);
		...
		Vector userVec = indvMaster.getInboxList(getDataSource(request, "student"), paramVec);
	...
	//  EntpMaster entpMaster =  new EntpMaster();
		...
		if(userVec.size()==0)
		{
			...
			strValue += "<td height=\"400\" valign=\"center\" colspan=\"7\" > No Data Found</td>";
			strValue += "</tr>";
		}
		else
			{strValue += "<tr >";
