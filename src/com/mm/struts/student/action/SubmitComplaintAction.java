...
public class SubmitComplaintAction extends LookupDispatchAction {
	...
	public ActionForward edit(ActionMapping mapping, ActionForm form,
		...
		writeComplaintForm.setOtherCategory("0");
		writeComplaintForm.setBrand("0");
		writeComplaintForm.setOtherBrand("0");
		writeComplaintForm.setCheckDealer("0");
		writeComplaintForm.setDealerName("0");
		writeComplaintForm.setAddress("0");
		writeComplaintForm.setCountry("0");
		writeComplaintForm.setOtherCountry("0");
		writeComplaintForm.setState("0");
		writeComplaintForm.setOtherState("0");
		writeComplaintForm.setCity("0");
		writeComplaintForm.setOtherCity("0");
		writeComplaintForm.setPincode("0");
		writeComplaintForm.setBlogtext(dataVec.elementAt(15).toString());
		writeComplaintForm.setReleventtext("0");
		writeComplaintForm.setQtype("0");				
		writeComplaintForm.setCons("0");
	...
	public ActionForward submit(ActionMapping mapping, ActionForm form,
		...
		String advtid=(String)session.getAttribute("fId");
		System.out.println("Company User Id is "+advtid);
		...
		if(((String)session.getAttribute("flagforw")).equalsIgnoreCase("1"))
		{
			 ...
			 */
			String CatID = dataVec.elementAt(1).toString();
			System.out.println("Category is "+CatID);
			...
			String advtId = "0";
//			System.out.println("Advertiser ID is +");
			String b_flag="1";
		    ...
		    dealerId = indvMaster.getStaffID(dataSource,CatID,advtid, creationDate,creationTime);
			System.out.println("Dealer ID in submit complaint action "+dealerId);
			
			if (Integer.parseInt(dealerId) == 0)
			{
				tagId="1";
			}
	//	    System.out.println("cecpoint 0");
	...
	//		Vector staff_present = rootMaster.getStaff(dataSource, numCatID);
			
		//	System.out.println("cecpoint 1");
			...
			complaintVec.add(CatID);						//Category
...
//			System.out.println("Complaint Vector is"+complaintVec);
...
//				To write a blog file.
	...
	public ActionForward draft(ActionMapping mapping, ActionForm form,
			...
			////System.out.println("advtId...brand id....."+advtId);
			...
			if((dataVec.elementAt(1).toString().equals("-1") || dataVec.elementAt(3).toString().equals("-1"))&& (!dataVec.elementAt(1).toString().equals("0")))
			{
				advtId = String.valueOf(indvMaster.getCompanyId(dataSource,"Advertiser","other"));
				otherBrand = dataVec.elementAt(4).toString();
				////System.out.println("advtId.....if..."+advtId);
			}
			else if(dataVec.elementAt(1).toString().equals("0")){
					
					int uid = Integer.parseInt(dataVec.elementAt(18).toString().trim());
					int C_uid =indvMaster.getCompanyId(dataSource, uid);
						advtId = String.valueOf(C_uid);
						////System.out.println("advtId.....else..."+advtId);
				}
			...
			draftVec.add(dataVec.elementAt(17).toString());	//Query type
			////System.out.println("QUERYYYYYYYYTYPEEEEEEEEEEEEEE>>>>>>>>>>"+dataVec.elementAt(17).toString());
			...
			if(status.equalsIgnoreCase("draftSuccess")){
				session.setAttribute("flagforw","0");
		...
		return mapping.findForward("draftSuccess");
	}
	...
	public String getCatData(DataSource dataSource,Vector dataVec)
	{
		...
		if(userCategory.equals("-1"))
		{
			...
			userCategory=rootMaster.insertCategory(dataSource,dataVec.elementAt(1).toString());//return category id
