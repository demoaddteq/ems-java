 ...
 */
public class BlogCategoryAction extends Action {
	/*
	 * Generated Methods
	 */
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		String industryCategory = (request.getParameter("indCategory1")!=null) ? request.getParameter("indCategory1") : " ";
		 System.out.println("industryblog Category......categoryAction......"+industryCategory);
		
		
		Vector categoryVec = rootMaster.getBlogCategories(getDataSource(request, "student"));
	    String strCat = getBCategoryList(industryCategory, categoryVec);
	...
	private String getBCategoryList(String industryCategory, Vector categoryVec)
	{
		String strResult ="<select name=\"blogCategory\"   tabindex=\"1\" onchange=\"outputSelected(this.form.blogCategory)\">";
