...
public class SearchPlaceAction extends Action {
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		if(!codeStrArr[0].equalsIgnoreCase("-1"))
		{
			 ...
			 * Country Start Here
			 */
			Vector CountryVec = rootMaster.getCountries(getDataSource(request,"student"));
			...
			else
			{
				...
				else
				{
				     ...
				     * State Start Here
				     */
				    Vector StateVec = rootMaster.getState(numCId, getDataSource(request, "student"));
				    ...
				    else
				    {
						...
						{				
							...
							{
								Vector placeVec = rootMaster.getPlace(numCId, numSId, getDataSource(request, "student"));
	...
	private String getTableRow(String strCountries, String strState, String strPlace, int numTempCount)
	{
		...
		strResult  += "<TD  width=\"26%\" bgColor=\"#ffffff\" height=\"30\">";
		strResult  += "<DIV class=\"bold\" align=\"right\">Country</DIV></TD>";
		...
		strResult  += "<DIV align=\"left\"></DIV></TD>";
		strResult  += "<TD  width=\"26%\" bgColor=\"#ffffff\" height=\"30\">";
		strResult  += "<DIV class=\"bold\" align=\"right\">State</DIV></TD>";
		strResult  += "<TD width=\"3%\" bgColor=\"#ffffff\">&nbsp;</TD>";
		...
		strResult  += "<DIV align=\"left\"></DIV></TD>";
		strResult  += "<TD  width=\"26%\" bgColor=\"#ffffff\" height=\"30\">";
		strResult  += "<DIV class=\"bold\" align=\"right\">City</DIV></TD>";
		strResult  += "<TD width=\"3%\" bgColor=\"#ffffff\">&nbsp;</TD>";
	...
	private String getPlaceList(int numPId, Vector placeVec, int numSId, int numCId)
	{
		...
		if(placeVec.size()>2)
		{
			strResult ="<select name=\"city\"  onchange=\"retrieveCountryStateCity('searchPlace.do?country="+numCId+"&state="+numSId+"&place='+this.value);\">";
