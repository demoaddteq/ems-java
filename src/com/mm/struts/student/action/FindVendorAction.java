...
import com.mm.struts.student.form.VendorForm;
...
public class FindVendorAction extends Action {
	...
	public ActionForward execute (
		...
		System.out.println("In Vendor action");
		VendorForm myVendorForm=(VendorForm)form;
		String operation = (String)request.getParameter("operation");
		DataSource myDataSource = getDataSource(request,"student");
		...
		try
		{
			...
			{	
				System.out.println("In Action for show");
