...
import com.mm.struts.indv.form.UploadPhotoForm;
...
public class UploadPhotoAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) throws Exception{
        ...
        { 
	        ...
	        {
	        	String tempphotoPath = indvMaster.getUserPhotoPath(getDataSource(request, "indv"),Integer.parseInt(uid));
	           ...
	           //ystem.out.println("bufi >>>>>>>>"+bufi.toString());
	           	...
	           	if(result)
	           	{
	           		...
	           		status = indvMaster.updatePhotoPath(getDataSource(request,"indv"),dataVec);
	           	}
	           	ActionErrors errors = new ActionErrors();
	           	errors.clear();
