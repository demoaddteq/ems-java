...
public class CountrystatecityWriteCompAction extends Action {
	...
	private String getTableRow(String strCountries, String strState, String strPlace, int numTempCount)
	{
		...
		strResult+="<td width=\"25%\" align=\"right\" class=\"Arial_12_black_normal\">* Country&nbsp;</td>";
		...
		{
			strResult+="<td  width=\"25%\" class=\"Arial_Narrow_11_blue_bold\" style=\"cursor:hand\" onclick=\"retrieveCountryStateCity('countrystatecityWriteComp.do?place=0&state=0&country=94~+91');\"><b><u><font color=\"blue\">Switch Back To List Mode</font></u></b></td>";
		}		
		strResult+="</tr>";
		strResult+="<tr height=\"20\">";
		strResult+="<td>&nbsp;</td>";
		strResult+="<td align=\"right\" class=\"Arial_12_black_normal\">* State&nbsp;</td>";
		...
		{
			strResult+="<td  class=\"Arial_Narrow_11_blue_bold\" style=\"cursor:hand\" onclick=\"retrieveCountryStateCity('countrystatecityWriteComp.do?place=0&state=0&country=94~+91');\"><b><u><font color=\"blue\">Switch Back To List Mode</font></u></b></td>";
		}
		strResult+="</tr>";
		strResult+="<tr height=\"20\">";
		strResult+="<td>&nbsp;</td>";
		strResult+="<td align=\"right\" class=\"Arial_12_black_normal\">* City&nbsp;</td>";
	...
	private String getCountriesList(int numCid, ArrayList CountryList, int numSId, int numPId, int tabindex, String strCIdOth)
	{
		...
		{
			strResult ="<select name=\"country\" class=\"input_multi_txt_box\" tabindex=\""+tabindex+"\" onchange=\"retrieveCountryStateCity('countrystatecityWriteComp.do?place="+numPId+"&state="+numSId+"&country='+this.value), setCountry()\">";
	...
	{
		String strResult = "<input type=\"text\" name=\"otherCountry\" id=\"otherCountry\" tabindex=\""+tabindex+"\" value=\""+strCIdOth+"\" class=\"var11_black_box_vvsmall\"><input type=\"hidden\" name=\"country\" id=\"country\" class=\"var11_black_box_vvsmall\" value=\"-1\">";
		return strResult;
	}
	private String getStateList(int numSid, int numCId, HashMap stateList, int numPId, int tabindex,String strSIdOth)
	{
		...
		if(AllStates.size()>2)
		{
			strResult ="<select name=\"state\" class=\"input_multi_txt_box\" tabindex=\""+tabindex+"\" onchange=\"retrieveCountryStateCity('countrystatecityWriteComp.do?country="+numCId+"&place="+numPId+"&state='+this.value);\">";
	...
	{
		String strResult = "<input type=\"text\" name=\"otherState\" id=\"otherState\" tabindex=\""+tabindex+"\" value=\""+strSIdOth+"\" class=\"var11_black_box_vvsmall\"><input type=\"hidden\" name=\"state\" id=\"state\" class=\"var11_black_box_vvsmall\" value=\"-1\">";
		return strResult;
	}
	private String getPlaceList(int numPId, HashMap citiesList, int numSId, int numCId, int tabindex, String strPIdOth)
	{
		...
		if(AllCities.size()>2)
		{
			strResult ="<select name=\"city\" class=\"input_multi_txt_box\"  tabindex=\""+tabindex+"\"  onchange=\"retrieveCountryStateCity('countrystatecityWriteComp.do?country="+numCId+"&state="+numSId+"&place='+this.value);\">";
	...
	{
		String strResult = "<input type=\"text\" name=\"otherCity\" id=\"otherCity\" tabindex=\""+tabindex+"\" value=\""+strPIdOth+"\" class=\"var11_black_box_vvsmall\"><input type=\"hidden\" name=\"city\" id=\"city\" class=\"var11_black_box_vvsmall\" value=\"-1\">";
		return strResult;
	}
