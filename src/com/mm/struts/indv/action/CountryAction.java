...
public class CountryAction extends Action {
	 ...
	 * onchange=\"retrieveSURL('state.do?country='+this.value), setCountry()\">";
	 */
	...
	{
		String strResult ="<select name=\"country\" class=\"input_combo_box\" tabindex=\"5\"  onchange=\"retrieveSURL('state.do?country='+this.value), setCountry()\">";
