...
import com.mm.struts.indv.form.ResponseForm;
...
public class ResponseAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) {
		...
		String result = rootMaster.insertResponse(getDataSource(request,"indv"),dataVec);
		...
		if(result.equalsIgnoreCase("success"))
		{
			if(!respId.equalsIgnoreCase("0"))
			{
				...
				result = rootMaster.updateResponseFlag(getDataSource(request,"indv"), respVec);
			}
		}
...
//////////////for mail///////////////
		if(result.equalsIgnoreCase("success"))
		{
			...
			complaintVec = entpMaster.getComplaintDetails(getDataSource(request,"indv"), cid);
			...
			paramVec.add(uid);
			paramVec.add(cu_id);
			Vector emailVec = indvMaster.getEmailList(getDataSource(request,"indv"), paramVec);
			Vector<String> tempMailParam = new Vector<String>();
			tempMailParam.add("Consumer");//sender company type Consumer
			tempMailParam.add("Enterprise");//receipient company type Enterprise
			...
			String mailTextLAlert = rootMaster.getMailText(getDataSource(request,"indv"), tempMailParam);
			...
			String subject = "Reply to your mail on Complaint Id ("+ fcomId + ") By "+ consumerName + ".";
