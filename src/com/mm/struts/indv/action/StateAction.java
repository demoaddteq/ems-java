...
public class StateAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		{
			strState ="<select name=\"state\" class=\"input_combo_box\" tabindex=\"10\"  onchange=\"retrievePURL('city.do?country="+numCId+"&state='+this.value), setState()\">";
	...
	private String getStateList(int numSid, int numCId, HashMap stateList)
	{
		...
		String strResult ="<select name=\"state\" class=\"input_combo_box\" tabindex=\"10\"  onchange=\"retrievePURL('city.do?country="+numCId+"&state='+this.value), setState()\">";
