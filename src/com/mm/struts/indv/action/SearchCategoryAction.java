...
public class SearchCategoryAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws Exception 
		{
				...
				Vector categoryVec = rootMaster.getCategories(getDataSource(request, "indv"));
			...
			{
				String strResult ="<select name=\"category\"  class=\"input_multi_txt_box\" tabindex=\"5\" onchange=\"retrieveBrandURL1('brandForCat.do?category='+this.value), setCategory()\">";
