...
import com.mm.struts.indv.form.DraftDeletionForm;
...
public class DraftDeletionAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		{
			paramVec.add(drafts);
			result = indvMaster.deleteDraft(getDataSource(request, "indv"), paramVec);
		}
		...
		if(result.equalsIgnoreCase("success"))
		{
			for(int i=0; i<draftIds.length; i++)
			{
				String strTempResult = indvMaster.deleteDraftUnnamed(getDataSource(request, "indv"), Integer.parseInt(draftIds[i].trim()));
