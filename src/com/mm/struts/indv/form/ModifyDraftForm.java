...
//	validatin for the Write Complaint form. it check other category,brand and contact person.
	...
	public ActionErrors validate(ActionMapping mapping, HttpServletRequest req)
	{
		...
		{
			errors.add("indvModifyDraftForm",new ActionError("errors.resource.other","Category"));
			if(this.otherBrand.trim().length()<=0)
			{
				errors.add("indvModifyDraftForm",new ActionError("errors.resource.other","Brand"));
			}
		}
		else
		{
		...
		if(this.checkDealer.equalsIgnoreCase("checked"))
		{
			...
			{
				errors.add("indvModifyDraftForm",new ActionError("errors.required","Dealer Name"));
			}
			if(this.address.length()==0)
			{
				errors.add("indvModifyDraftForm",new ActionError("errors.required","Dealer Address"));
			}
			if(this.country.equals("0~+0"))
			{
				errors.add("indvModifyDraftForm",new ActionError("errors.required","Dealer Country"));
			}
			if(this.state.equals("0"))
			{
				errors.add("indvModifyDraftForm",new ActionError("errors.required","Dealer State"));
			}
			if(this.city.equals("0"))
			{
				errors.add("indvModifyDraftForm",new ActionError("errors.required","Dealer City"));
			}
			if(this.country.equals("-1~+0") && this.otherCountry.length()<=0)
			{
				errors.add("indvModifyDraftForm",new ActionError("errors.resource.other","country"));
				if(this.otherState.length()<=0)
				{
					errors.add("indvModifyDraftForm",new ActionError("errors.resource.other","state"));
					if(this.otherCity.length()<=0)
					{
						errors.add("indvModifyDraftForm",new ActionError("errors.resource.other","city"));
					}
				}
			}
			else
			...
			if(req.getParameterValues("field"+i)!= null)
			{
				...
				if(strValue.trim().equalsIgnoreCase("1"))
				{
					...
					if(i<11)
					{
						...
						{
							errors.add("indvModifyDraftForm",new ActionError("errors.required",strFldName));
						}
					}
					else
					{
