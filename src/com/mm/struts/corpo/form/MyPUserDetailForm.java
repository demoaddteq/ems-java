...
public class MyPUserDetailForm extends ValidatorForm {
	...
	public ActionErrors validate(ActionMapping mapping, HttpServletRequest req)
	{
		...
		{
			errors.add("corpoUserdetailsForm",new ActionError("errors.resource.other","country"));
			if(this.otherstate.length()<=0)
			{
				errors.add("corpoUserdetailsForm",new ActionError("errors.resource.other","state"));
				if(this.othercity.length()<=0)
				{
					errors.add("corpoUserdetailsForm",new ActionError("errors.resource.other","city"));
				}
			}
		}
		else
		...
		if(this.txtPPrefix.length()>0)
		{
			...
			{
				errors.add("corpoUserdetailsForm",new ActionError("errors.resource.match","phone prefix" , "mobile prefix"));
			}
		}
		if(this.txtPPrefix.equals("-1") || this.txtMobile.equals("-1"))
		{
			errors.add("corpoUserdetailsForm",new ActionError("errors.resource.valid","phone or mobile prefix"));
		}
		return errors;
	}
	/**
	...
	/**
	 * @return the landPrefix
	 */
	public String getLandPrefix() {
		return landPrefix;
	}
	/**
	 * @param landPrefix the landPrefix to set
	 */
	public void setLandPrefix(String landPrefix) {
