...
public class UnAllotedComplaintForm extends ActionForm {
	...
	public ActionErrors validate(ActionMapping mapping,
		...
		{
			errors.add("corpounAllotedComplaintForm",new ActionError("errors.resource.allot","Complaint"));
		}
		if(this.brandUser.equals("0"))
		{
			errors.add("corpounAllotedComplaintForm",new ActionError("errors.resource.allot","Brand User"));
		}
		return errors;
	}
