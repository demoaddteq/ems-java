...
public class ConsumerBillsForm  extends ValidatorForm{

	//insert into consumer_bills (facilityid,serviceid,residentid,previousmeterreading,currentmeterreading,
	//billstartdate,billenddate,createdby,createdon)  values(?,?,?,?,?,?,?,?,CURDATE());
	
	private int facilityId;
	private int serviceId;
	private int residentId;
	private Float preMeterReading;
	private Float curMeterReading;
	...
	/**
	 * @return the curMeterReading
	 */
	public Float getCurMeterReading() {
		return curMeterReading;
	}

	/**
	 * @param curMeterReading the curMeterReading to set
	 */
	public void setCurMeterReading(Float curMeterReading) {
		this.curMeterReading = curMeterReading;
	}

	/**
	 * @return the preMeterReading
	 */
	public Float getPreMeterReading() {
		return preMeterReading;
	}

	/**
	 * @param preMeterReading the preMeterReading to set
	 */
	public void setPreMeterReading(Float preMeterReading) {
		this.preMeterReading = preMeterReading;
	}
