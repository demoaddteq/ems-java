...
public class GetUnallotedComplaintsAction extends Action {
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		int totalRow = advtMaster.getUnallottedComplaintCount(getDataSource(request, "corpo"), paramVec1);	
		String strPageHtml = getPages(minVal, maxVal, totalRow, numCount);
		String strCoreUser = getBrandUser(request,compId,uId);
		Vector userVec = advtMaster.getUnAllottedComplainsList(getDataSource(request, "corpo"), paramVec);
	...
	private String getComplaintList(HttpServletRequest request ,String strComIdOrder, String strCTitelOrder,String strDateOrder, int minVal, String strPageHtml, Vector userVec,String strCoreUser,int reminder)
	{
		...
		strValue += "<tr >";
		strValue += "<td colspan=\"2\" align=\"left\" >Core User "+strCoreUser+"</td>";
...
//		 	for check length of Complaint text
	     ...
	     String brand_Name = rootMaster.getBrandName(getDataSource(request, "corpo"), advtid);
		...
		String catName = rootMaster.getStrCategoryName(getDataSource(request, "corpo"),catid);
	...
	private String getBrandUser(HttpServletRequest request , String compId,String uId)
	{
		...
		Vector cureUserVec = rootMaster.getUserList(getDataSource(request, "corpo"),Integer.parseInt(compId));
