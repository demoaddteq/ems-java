...
import com.mm.struts.corpo.form.QueryResponseForm;
 ...
 */
public class QueryResponseAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) {
		QueryResponseForm responseForm = (QueryResponseForm) form;// TODO Auto-generated method stub
		...
		String result = rootMaster.insertResponse(getDataSource(request,"corpo"),dataVec);
		...
		if(result.equalsIgnoreCase("success"))
		{
			...
			String cu_id = complaintVec.elementAt(9).toString();
