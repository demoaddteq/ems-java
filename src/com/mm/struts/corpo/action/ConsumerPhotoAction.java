...
public class ConsumerPhotoAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		*/
		String photoPath = indvMaster.getUserPhotoPath(getDataSource(request, "corpo"),uid);   		
		UploadPhotoForm CorpoUploadPhotoForm = new UploadPhotoForm();
		    			    		
		CorpoUploadPhotoForm.setPhotoPath(photoPath);
		   
           request.setAttribute("corpoUploadPhotoForm",CorpoUploadPhotoForm);
