...
import com.mm.struts.corpo.form.CommunitySUnnameForm;
...
String rid=rootMaster.getRightId(ds, CompId);
	...
	Vector resultVec = entpMaster.getCommunityUnnamedMap( getDataSource(request, "corpo") ,Integer.parseInt(CompId));		
