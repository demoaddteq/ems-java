...
public class InboxAction extends Action {
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		int totalRow = advtMaster.getInboxCount(getDataSource(request, "corpo"), paramVec1);
		...
		Vector userVec = advtMaster.getInboxList(getDataSource(request, "corpo"), paramVec);
