...
public class CityAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		String strPlace = "";
		if((request.getParameter("state")!=null)&& (numSId!=0 && numSId!=-1))
		{	
		...
		{	
			strPlace ="<select name=\"city\" class=\"input_combo_box\" tabindex=\"11\"  onchange=\"showOth()\">";
	...
	private String getPlaceList(int numPId, int numSId, HashMap citiesList,int numCId)
	{
		...
		String strResult ="<select name=\"city\" class=\"input_combo_box\" tabindex=\"11\" onchange=\"showOth();\">";
