...
public class AddMemberAction extends Action {
			...
			HttpServletRequest request, HttpServletResponse response) 
	{
	    ...
	    String rightId="";
	    AddMemberForm communityselectionForm = (AddMemberForm) form;
		...
		else
		{
		    ...
		    ArrayList arrFacilityData = rootMaster.getDataOfCurrentFacility(dataSource, strUserId);
		    ArrayList arrtemp = (ArrayList)arrFacilityData.get(0);
		    System.out.println("arrFacilityData=>"+arrFacilityData);
		    
		    //set country ,state and city in data base in case of other
			String userCountry = arrtemp.get(0).toString();
			String userState = arrtemp.get(1).toString();
			String uCity = arrtemp.get(2).toString();
			String builderID = arrtemp.get(3).toString();
			String Facility = arrtemp.get(4).toString();

			System.out.println("4545545userCountry=>"+userCountry);
			System.out.println("userState=>"+userState);
			System.out.println("uCity=>"+uCity);
			System.out.println("builderID=>"+builderID);
			System.out.println("Facility=>"+Facility);
			
			
/*
 * 
 * commented by Renuka 04.10.2009
