...
import com.mm.struts.corpo.form.UnAllotedComplaintForm;
...
public class UnAllotedComplaintAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		String uId  = unAllotedComplaintForm.getBrandUser();
		...
		status = advtMaster.updateComplaint(dataSource,uId, dataVec);
		if(status.equalsIgnoreCase("success"))
		{
			...
			String branduserName = "";
				...
				if(MasilId.size()==1)
				{
					...
					String subjectBrand = "Allot some Complaints.";
					...
					String strMailText = mailtext.getETextForBrandNewComplaint(brandDataVec,finalCompId,mailTextLAlert);
					String strFinalStatus1 = resource.sendMail(strMailText, Constant.Email_Sender,branduserMail, subjectBrand);
			...
			msg.clear();
			msg.add("allotement", new ActionError("errors.allotment.Success",branduserName));
		...
		Vector advtCountVec = advtMaster.complaintCountAdvt(getDataSource(request, "corpo"), dataVec2);		
		session.setAttribute("advtCountVec", advtCountVec);						
		////////System.out.println("advtCountVec.............UnAllotedComplaintAction........... "+advtCountVec);
