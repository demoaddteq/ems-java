...
public class ComplaintDetailAction extends Action {
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		////System.out.println("aType..in Action corpo..Detail......."+aType);
...
//		    	complainant Information
		    	...
		    	Vector commentVec=rootMaster.getCommentsList(getDataSource(request, "corpo"), Integer.parseInt(numCompId));
		    	//System.out.println("dealer_id, ..on ComplaintDetail page..."+commentVec);
		    	if(dealer_id!= 0)
		    	{
		    	...
		    	{
		    		catName=rootMaster.getStrCollegeCategoryName(getDataSource(request, "corpo"), cat_id);
		    	}
		...
		String strDetailHtml ="";
	        ...
	        strDetailHtml+="<tr >";
			 ...
			 strDetailHtml+="</tr>";
		        ...
		        Vector status= indvMaster.getProcessedList(getDataSource(request, "corpo"),cid);
        ...
        strDetailHtml+="<tr height=\"60\">";
		 ...
		 strDetailHtml+="</tr>";
			  ...
			  // End td for additional detail
			  	...
			  	int reqCount= indvMaster.getMentorTotalCount(getDataSource(request, "corpo"),uid);
			  	//////////System.out.println("reqCountreqCountreqCountreqCount>>>>>>>>>>"+reqCount);
			  
			
		        
				strDetailHtml+="<tr id=\"row\" >";
		        ...
		        if(!(pageid.equals("5") || pageid.equals("6")))
		        {
						...
						if(brandresponse==0)
						{
							...
							strDetailHtml +="</tr>";
							strDetailHtml += "<tr align=\"left\" id=\"resp\" id=\"accept\" style=\"display:none\">";
		        ...
		        if(!(pageid.equals("5") || pageid.equals("6")))
		        {
					...
					if(responseVec.size()>0)
					{
						for(int i=0;i<responseVec.size();i++)
						{
							...
							if((!comptype.equalsIgnoreCase("Company")) && response_flag == 0)
							{
						...
						strDetailHtml+="</tr>";
							...
							strDetailHtml += " <tr>";
							strDetailHtml += " <td colspan=\"2\"  align=\"left\" valign=\"top\" class=\"bold\" width=\"100%\" height=\"45\"> <table height=\"100%\" width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tr><td height=\"100%\" width=\"15%\"  valign=\"top\">&nbsp;Response Text: </td>";
						  ...
						  if(commentVec.size()>0)
							{
					        	...
					        	for(int i=0;i<commentVec.size();i++)
								{
									...
									String ccityName = rootMaster.getPlaceName(getDataSource(request, "corpo"),ccityId);
									
									
									int comp_id = Integer.parseInt(tempVec.elementAt(5).toString().trim());
									String compName = rootMaster.getComp_Type(getDataSource(request, "corpo"),comp_id);
						...
						}else
						{
							...
							strDetailHtml+="<input name=\"accept\" type=\"button\"    value=\"Back\" onclick=\"back()\"></td>";
							strDetailHtml+="</tr>";
						}
