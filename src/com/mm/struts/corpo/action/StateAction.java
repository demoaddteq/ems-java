...
public class StateAction extends Action {
	 ...
	 * onchange=\"retrieveMyProCityURL('city.do?country="+numCId+"&state='+this.value),showOth();\">";
	 */
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		{
			strState ="<select name=\"state\"  tabindex=\"10\"  onchange=\"retrieveMyProCityURL('city.do?country="+numCId+"&state='+this.value),showOth();\">";
