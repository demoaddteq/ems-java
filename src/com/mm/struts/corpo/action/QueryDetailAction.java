...
import com.mm.core.master.*;
	public class QueryDetailAction extends Action {
		...
		//	    	-------------------------
			    	...
			    	Vector complaintVec = advtMaster.getQueryDetails(getDataSource(request, "corpo"),paramVec2);
...
////////////////////////////////////////////////////////////////////////////	//
		...
		{
			String strResult ="<select name=\"paging\" onchange=\"retrieveCorpoQueryDetailURL('queryDetail.do?'+this.value);\">";
			int numMin = 0;
			int numPage = 1;
