...
public class UsercreationAction extends Action
{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) {
		UsercreationForm usercreationForm = (UsercreationForm) form;// TODO Auto-generated method stub
			...
			{
				strMailText = mt.getETextForAdvtUserReg(usercreationForm.getLoginName(), usercreationForm.getPassword(), usercreationForm.getFname(), usercreationForm.getLname());
			
			
			String strEmailStatus = resr.sendMail(strMailText, Constant.Email_Sender, usercreationForm.getEmail(), Constant.Email_Title_For_UCreation);
			//////System.out.println("str Email Status in corpo user....."+strEmailStatus);
