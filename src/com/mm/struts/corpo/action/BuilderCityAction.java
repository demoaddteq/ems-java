...
public class BuilderCityAction extends Action{
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		Vector streamVec = rootMaster.getBuilderCityList(getDataSource(request, "corpo"), builderId);
	...
	private String getCourseStreamList(int numSid, int numCId, Vector streamVec)
	{
		...
		System.out.println("strResult--07092009 2 In City Action New=>"+strResult);
		strResult += "</select>";
		return strResult;
	}
