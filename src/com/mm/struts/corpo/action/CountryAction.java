...
public class CountryAction extends Action {
	 ...
	 * onchange=\"retrieveMyProStateURL('state.do?country='+this.value),showOth(); setCountryCode();\">";
	 */
	...
	{
		String strResult ="<select name=\"country\"  tabindex=\"5\"  onchange=\"retrieveMyProStateURL('state.do?country='+this.value),showOth(); setCountryCode();\">";
