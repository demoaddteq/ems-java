...
public class UsergroupdetailAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		Vector listVec= am.getUserGroupDetails(getDataSource(request, "corpo"), numCompId, numUrId, strType);
		//////System.out.println("listVec....................."+listVec);
		
		Vector completeVec = getAllRightsList(listVec);
		//////System.out.println("completeVec....................."+completeVec);
	...
	private String getUserGroup(Vector completeVec, String strType, int numUrId, int numTempCount)
	{
		...
		strResult += "<td align=\"right\" class=\"bold\">User Rights Group Name&nbsp;&nbsp;</td>";
		...
		strResult += "</tr>";
		strResult += "<tr height=\"30\">";
		strResult += "<td align=\"right\" class=\"bold\">Available Rights&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>";
		strResult += "<td></td>";
		strResult += "<td align=\"left\" class=\"bold\">&nbsp;&nbsp;&nbsp;Assigned Rights </td>";
		strResult += "</tr>";
		strResult += "<tr>";
