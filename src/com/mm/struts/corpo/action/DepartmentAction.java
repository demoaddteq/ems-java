...
public class DepartmentAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		String type = (request.getParameter("type")!=null) ? request.getParameter("type") : "corporates";
		RootMaster rootMaster= new RootMaster();
		int numdepId=Integer.parseInt(StrCourseId);
		Vector CourseVec = rootMaster.getdepCategory(getDataSource(request, "corpo"), type);
