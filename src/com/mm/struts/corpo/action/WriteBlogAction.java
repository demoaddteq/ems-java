...
import com.mm.struts.corpo.form.WriteBlogForm;
...
public class WriteBlogAction extends Action {
	...
	if(numCatID!=-1 && category.length()>0 && numCatID!=0 )
	{
		...
		if(qcat.equalsIgnoreCase("Advertiser")||qcat.equalsIgnoreCase("student")){
			...
			categoryName  = rootMaster.getStrCollegeCategoryName(getDataSource(request, "corpo"), numCatID);
		}
		...
		if(request.getParameterValues("field"+i)!= null)
		{
			...
			if(strTemp.length()>0)
			{
				...
				if(strFlag.indexOf("true") <= -1)
				{
					if(i==1)
					{
						strSubCatVal = im.getValueSubCat1(getDataSource(request, "corpo"), Integer.parseInt(strTemp.trim()));
					}
					if(i==2)
					{
						strSubCatVal = im.getValueSubCat2(getDataSource(request, "corpo"), Integer.parseInt(strTemp.trim()));
					}
					if(i==3)
					{
						strSubCatVal = im.getValueSubCat3(getDataSource(request, "corpo"), Integer.parseInt(strTemp.trim()));
					}
					if(i==4)
					{
						strSubCatVal = im.getValueSubCat4(getDataSource(request, "corpo"), Integer.parseInt(strTemp.trim()));
					}
					if(i==5)
					{
						strSubCatVal = im.getValueSubCat5(getDataSource(request, "corpo"), Integer.parseInt(strTemp.trim()));
					}
					if(i==6)
					{
						strSubCatVal = im.getValueSubCat6(getDataSource(request, "corpo"), Integer.parseInt(strTemp.trim()));
					}
					if(i==7)
					{
						strSubCatVal = im.getValueSubCat7(getDataSource(request, "corpo"), Integer.parseInt(strTemp.trim()));
					}
					if(i==8)
					{
						strSubCatVal = im.getValueSubCat8(getDataSource(request, "corpo"), Integer.parseInt(strTemp.trim()));
					}
					if(i==9)
					{
						strSubCatVal = im.getValueSubCat9(getDataSource(request, "corpo"), Integer.parseInt(strTemp.trim()));
					}
					if(i==10)
					{
						strSubCatVal = im.getValueSubCat10(getDataSource(request, "corpo"), Integer.parseInt(strTemp.trim()));
					}
