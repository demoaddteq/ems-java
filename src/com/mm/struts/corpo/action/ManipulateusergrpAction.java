...
import com.mm.struts.corpo.form.ManipulategrpForm;
...
public class ManipulateusergrpAction extends Action {
	...
	//		Company Id
			...
			{
				target = am.deleteUserGroup(getDataSource(request, "corpo"), Integer.parseInt(strGRid.trim()), Integer.parseInt(strCompId.trim()));
				
				String resultRud = am.updateRid(getDataSource(request, "corpo"), Integer.parseInt(strGRid.trim()), Integer.parseInt(strCompId.trim()));
				
				
				////System.out.println("resultRud ...................>"+resultRud);
			...
			String strAllRights = "accmanagement, users, usercreation, userdeletion, usermodification, change_password, complaintmanagement, mis, complaints, test_creation, mentoring";
			...
			{	
				...
				target = am.setUserGroup(getDataSource(request, "corpo"), dataVec); 
			...
			{
				target = am.editUserGroup(getDataSource(request, "corpo"), dataVec);
