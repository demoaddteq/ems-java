...
public class UploadPhotoAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) throws Exception{
        ...
        { 
	        ...
	        {
	        	String tempphotoPath = indvMaster.getUserPhotoPath(getDataSource(request, "entp"),Integer.parseInt(uid));
	           ...
	           //ystem.out.println("bufi >>>>>>>>"+bufi.toString());
	           	...
	           	if(result)
	           	{
	           		...
	           		status = indvMaster.updatePhotoPath(getDataSource(request,"entp"),dataVec);
	           	}
	           	ActionErrors errors = new ActionErrors();
