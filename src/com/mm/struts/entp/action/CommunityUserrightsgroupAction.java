...
public class CommunityUserrightsgroupAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		//System.out.println("totalRow....CommunityUserrightsgroupAction........."+totalRow);
		...
		//System.out.println("listVec.....CommunityUserrightsgroupAction........"+listVec);
	...
	private String getGroups( String strgnameOrder, int minVal, String strPageHtml,Vector lstVec, int numTempCount,int numCompId)
	{
		...
		else
		{
		    ...
		    String strgnameSymbol = (strgnameOrder.trim().equalsIgnoreCase("asc")) ? "<img style=\"cursor:hand\" src=\"../images/downarrow.gif\" onClick=\"retrieveUserGrp('communityUserrightsgroup.do?sby=groupname&numMin="+ minVal+"&grporder="+strgnameOrder+"&compId="+numCompId+"');\">" : "<img style=\"cursor:hand\" src=\"../images/uparrow.gif\" onClick=\"retrieveUserGrp('communityUserrightsgroup.do?sby=groupname&numMin="+ minVal+"&grporder="+strgnameOrder+"&compId="+numCompId+"');\">";
			...
			for(int i=0; i<lstVec.size(); i++)
			{
				...
				strResult+="<td  align=\"center\"  style=\"cursor:hand\" onclick=\"javascript:location='communityManipulategrp.jsp?typ=Details&grpid="+numGrId+"'\" class=\"bold\">Details</td>";
				strResult+="<td align=\"center\"   style=\"cursor:hand\" onclick=\"javascript:location='communityManipulategrp.jsp?typ=Modify&grpid="+numGrId+"'\" class=\"bold\">Modify</td>";
				
				strResult+="<td  align=\"center\"   style=\"cursor:hand\" onclick=\"javascript:location='communityManipulategrp.jsp?typ=Delete&grpid="+numGrId+"'\" class=\"bold\">Delete</td>";
		...
		strResult += "</tr>";
		strResult+="<tr>";
		strResult+="<td align=\"center\" >&nbsp;&nbsp;&nbsp;<input type=\"button\" name=\"add\" value=\"Add New\"  onclick=\"javascript:location='communityManipulategrp.jsp?typ=Add New'\"></td>";
	...
	private String getGroupsOption(int numGroupId, int numPageState, Vector lstVec, int numTempCount, int adminFlag)
	{
		...
		strResult += "<tr>";
		if(adminFlag == 1){
			strResult += "<td colspan=\"6\"  align=\"left\" style=\"cursor:hand\" onclick=\"javascript:location='communityUsrgroup.jsp'\"><font color=\"blue\"><u><b>Show all Rights Group</b></u></font></td>";
			
			strResult += "<td  align=\"right\" style=\"cursor:hand\" onclick=\"javascript:location='communityManipulategrp.jsp?typ=Add New'\"><font color=\"blue\"><u><b>Add More Rights Group</b></u></font></td>";
			strResult += "</tr>";
			...
			strResult += "<td colspan=\"6\" class=\"bold\">&nbsp;COMMUNITY RIGHTS GROUPS</td>";
			strResult += "<td ></td>";
			strResult += "</tr>";
		}
		else
	...
	{
		String strResult ="<select name=\"paging\" onchange=\"retrieveUserGrp('communityUserrightsgroup.do?compId="+compId+"&numCount="+numTempCount+"&'+this.value);\">";
		int numMin = 0;
		int numPage = 1;
