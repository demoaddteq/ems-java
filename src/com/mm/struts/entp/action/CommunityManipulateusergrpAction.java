...
import com.mm.struts.entp.form.CommunityManipulategrpForm;
...
public class CommunityManipulateusergrpAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServerException 
	{
		...
		//System.out.println("..............CommunityManipulateusergrpAction ............");
		
		String target = new String("failure");
			
			EntpMaster entpMaster = new EntpMaster();
			RootMaster rootMaster = new RootMaster();
			CommunityManipulategrpForm mgf = (CommunityManipulategrpForm)form;
			HttpSession session = request.getSession();
			int numTempCount = Integer.parseInt(mgf.getTempcount().trim());
			String strPageTarget = "communityManipulategrp.jsp?numCount="+numTempCount;
	//		Company Id
			String strCompId = "0";
			
			//System.out.println("strCompId..........CommunityManipulateusergrpAction ............"+strCompId);
			...
			{
				//System.out.println("...insid else if ....Delete.....");
				target = entpMaster.deleteCommunitRightsGroup(getDataSource(request, "entp"), Integer.parseInt(strGRid.trim()));
			...
			{	
				...
				target = entpMaster.setCommunitRightsGroup(getDataSource(request, "entp"), dataVec);
			...
			{
				target = entpMaster.editCommunitRightsGroup(getDataSource(request, "entp"), dataVec);
				if(target.equalsIgnoreCase("success")){
					ActionErrors errors = new ActionErrors();
		           	errors.clear();
