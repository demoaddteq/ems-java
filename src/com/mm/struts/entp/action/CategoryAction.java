...
public class CategoryAction extends Action {
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		Vector categoryVec = rootMaster.getCategories(getDataSource(request, "entp"));
	...
	{
		String strResult ="<select name=\"companyTemplate\" multiple=\"true\" size=\"5\" class=\"input_multi_txt_box\" tabindex=\"15\" onchange=\"outputSelected(this.form.companyTemplate)\">";
		
		String strTemCat[] = industryCategory.split(",");
		
		
		for(int i=1; i<categoryVec.size(); i++)
		{	
			int flag = 0;
			...
			for(int j =0; j<strTemCat.length; j++){
				...
				if(numCatId.equalsIgnoreCase(strTemCat[j].trim())){
					flag = 1;	
