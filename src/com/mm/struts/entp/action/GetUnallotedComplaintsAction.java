...
public class GetUnallotedComplaintsAction extends Action {
	...
	{
		//System.out.println("....GetUnallotedComplaintsAction.......");
		...
		//System.out.println("adminFlag....GetUnallotedComplaintsAction......."+adminFlag);
	...
	private String getComplaintList(HttpServletRequest request ,String strComIdOrder, String strCTitelOrder,String strDateOrder, int minVal, String strPageHtml, Vector userVec,String strCoreUser,int reminder)
	{
		...
		strValue += "<tr >";
		strValue += "<td colspan=\"2\" align=\"left\" >CampusYogi User "+strCoreUser+"</td>";
...
//			for check length of Complaint text
	    ...
	    strValue += "<td ><a href=\"allComplaints.jsp?pageid=8&pgtyp=Details&numCopmId="+comId+"\"><img alt=\"Click here to see detail\" src=\"../images/"+strImg.trim()+"\" width=\"58\" height=\"24\" border=\"0\"></img></a></td>";	
	    strValue += "</tr>";	
	    ...
	    strValue += "</tr>";	
	    strValue += "<tr >";
	    strValue +="<td colspan=\"2\" align=\"left\" >&nbsp;&nbsp;<input type=\"submit\" id=\"submit\" name=\"submit\"  value=\"Allote Complaint\" disabled=\"true\"></input></td>";
	...
	{
		RootMaster  rootMaster = new RootMaster();
		String strResult ="<select name=\"coreUser\" >";
