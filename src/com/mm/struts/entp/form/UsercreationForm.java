...
//	private String rdbgroup;
	...
	{	
		...
		{
			errors.add("entpUsercreationForm",new ActionError("errors.resource.match","password" , "retype password"));
		}
		if(this.country.equals("-1~+0") && this.otherCountry.length()<=0)
		{
			errors.add("entpUsercreationForm",new ActionError("errors.resource.other","country"));
			if(this.otherState.length()<=0)
			{
				errors.add("entpUsercreationForm",new ActionError("errors.resource.other","state"));
				if(this.otherCity.length()<=0)
				{
					errors.add("entpUsercreationForm",new ActionError("errors.resource.other","city"));
				}
			}
		}
		else
		...
		if(this.txtPPrefix.length()>0)
		{
			...
			{
				errors.add("entpUsercreationForm",new ActionError("errors.resource.match","phone prefix" , "mobile prefix"));
			}
		}
		if(this.txtPPrefix.equals("-1") || this.txtPrefix.equals("-1"))
		{
			errors.add("entpUsercreationForm",new ActionError("errors.resource.valid","phone or mobile prefix"));
		}
		return errors;
	}
