...
public class CollegecategoryAction extends Action {
	/*
	 * Generated Methods
	 */
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		Vector categoryVec = rootMaster.getCollegeCategories(getDataSource(request, "main"));
	...
	{
		String strResult ="<select name=\"companyTemplate\" multiple=\"true\" size=\"3\"  tabindex=\"15\" onchange=\"outputSelected(this.form.companyTemplate)\">";
