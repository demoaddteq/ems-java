 ...
 */
public class StudentStateAction extends Action {
	 ...
	 * onchange=\"retrieveStuCityURL('studentCity.do
	 */
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		System.out.println("numCId  Hexa=>"+numCId);
		...
		{
			strState ="<select name=\"companyState\"  tabindex=\"10\" onchange=\"retrieveStuCityURL('studentCity.do?collcountry="+numCId+"&collstate='+this.value), showOth();\">";
	...
	private String getStateList(int numSid, int numCId, HashMap stateList,int tabindex)
	{
		...
		System.out.println("getStateList==>"+numSid+"--");
		  
		ArrayList AllStates = (ArrayList)stateList.get(numCId);
		
			strResult ="<select name=\"companyState\"  tabindex=\""+tabindex+"\" onchange=\"retrieveStuCityURL('studentCity.do?collcountry="+numCId+"&collstate='+this.value), showOth();\">";
