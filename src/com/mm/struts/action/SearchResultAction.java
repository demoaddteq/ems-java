...
public class SearchResultAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if(searchFor.equalsIgnoreCase("0")){
			...
			String strPageHtml = getPages(minVal, maxVal, totalRow, searchFor);
	...
	private String getCollegeString(String searchFor, DataSource dataSource,Vector complaintVec , String strPageHtml,int numcount,int minVal,int maxVal,int totalRow, Vector cscVec,String category,String categoryName,String cityName, String firstName)
	{
		...
		strValue +="<TBODY>";
		strValue +=" <TR>";
		strValue +=" <TD width=\"100%\" bgColor=\"#cccccc\">";
		strValue +=" <TABLE cellSpacing=0 cellPadding=0  align=center bgColor=#ffffff border=0>";
		strValue +=" <TBODY>";
		strValue +=" <TR>";
		strValue +=" <TD >";
		...
		strValue +=" <TR>";
		strValue +=" <TD width=\"500\" height=\"28\" >&nbsp;&nbsp;&nbsp;&nbsp;</TD>";
		strValue +=" <TD width=\"160\" align=\"center\" ></TD></TR>";	
		strValue +=" <TR>";
		...
		strValue +="  <TR>";
		strValue +="   <TD >";
		strValue +="   <TABLE cellSpacing=0 cellPadding=0  bgColor=#000000 border=0>";
		strValue +="    <TBODY>";
		strValue +="   <TR>";
		strValue +="   <TD>";
		strValue +="   <TABLE cellSpacing=0 cellPadding=0  align=center bgColor=#ffffff border=0>";
		...
		strValue +="  <TABLE  width=\"660\"  border=0 cellPadding=0 cellSpacing=0>";
		strValue +=" <TBODY>";
		strValue +=" <TR>";
		...
		strValue +=" <tr >";
		strValue +="   <TD width=\"40%\" bgcolor=\"#FFFFFF\" ><a href=\"search.jsp?searchFor="+searchFor+"\" ><b>Click here to start New search</b></a></TD>";

		strValue +=" <td align=\"left\" >";
		if(numcount != 0)
		{
			strValue += " <b>Total Matches Found:</b> "+totalRow+"";
		}
		...
		strValue +=" <tr >";
		strValue +=" <td colspan=\"3\"><hr color=\"#F3F3F5\"></td></tr>";
		strValue +=" <TR>";
		strValue +=" <TD height=\"30\" colspan=\"2\" align=\"left\" valign=\"bottom\" >&nbsp;&nbsp;<b>Search Criteria:</b>&nbsp;&nbsp;";
		if(!category.equalsIgnoreCase(""))
		{
			strValue +=" <Strong >Category:</Strong>&nbsp;<span >"+categoryName+"</span>&nbsp;&nbsp;";
		}
		if(!cityName.equalsIgnoreCase(""))
		{
			strValue +=" <Strong >City:</Strong>&nbsp;<b>"+cityName+"</b>&nbsp;&nbsp;";
		}
		if(!firstName.equalsIgnoreCase(""))
		{
			strValue +=" <Strong >College Name like:</Strong>&nbsp;<b >"+firstName+"</b>&nbsp;&nbsp;";
		}
	...
	strValue +="  <td colspan=\"5\" valign=\"middle\" >";
			strValue +="<table width=\"100%\" bgcolor=\""+strColor+"\" >";
				...
				//strValue +="<td width=\"20%\" bgcolor=\""+strColor+"\" ></td>";
					...
					strValue +="<table width=\"100%\" bgcolor=\""+strColor+"\">";
					strValue +=" <tr align=\"left\" valign=\"bottom\" bgcolor=\""+strColor+"\"  height=\"30\">";
					strValue +="  <td colspan=\"5\" valign=\"top\"  bgcolor=\""+strColor+"\" >&nbsp;";
					strValue +=" <strong><font color=\"#0033FF\"><A href=\"compProfilePre.do?pageid=3&cuid="+compId+"&detailFor=Advertiser\">"+comDisName+" </A></font></strong></td>";
					strValue +=" </tr>";
					
									
					strValue +=" <tr align=\"left\" valign=\"bottom\" bgcolor=\""+strColor+"\">";
					strValue +="  <td colspan=\"5\" valign=\"top\"  bgcolor=\""+strColor+"\" >&nbsp;";
...
strValue +=" </td>";
strValue +=" </tr>";
strValue +=" <tr align=\"right\" height=\"15\">";
strValue +="  <td colspan=\"5\" valign=\"middle\">";
strValue +=" </tr>";
		...
		if(totalRow>maxVal){
			...
			if(minVal==0){
				...
				strValue +=" <td colspan=\"3\"  align=\"left\"><span style=\"cursor:hand\"  class=\"required\" onclick=\"retrieveSComplistURL('searchResult.do?searchFor="+searchFor+"&numMin="+(minVal+maxVal)+"');\" > Next Page</span></td>";
				
			}else if((totalRow - minVal)<= maxVal){
				
				strValue +=" <td colspan=\"3\"  align=\"left\"><span style=\"cursor:hand\" class=\"required\" onclick=\"retrieveSComplistURL('searchResult.do?searchFor="+searchFor+"&numMin="+(minVal-maxVal)+"');\" >Previous Page </span></td>";
				
			}
			else{
			
			strValue +=" <td colspan=\"3\"  align=\"left\"><span style=\"cursor:hand\" class=\"required\" onclick=\"retrieveSComplistURL('searchResult.do?searchFor="+searchFor+"&numMin="+(minVal-maxVal)+"');\" >Previous Page </span> <span style=\"cursor:hand\"  onclick=\"retrieveSComplistURL('searchResult.do?searchFor="+searchFor+"&numMin="+(minVal+maxVal)+"');\" >&nbsp;&nbsp;|&nbsp;&nbsp; Next Page </span></td>";
			}
			strValue +=" </tr>";
		}
		...
		strValue +="  <td height=\"200\" colspan=\"5\" align=\"center\" valign=\"middle\" bgcolor=\"#FFFFFF\"><b >No College(s) found. </b></td>";
		strValue +="  </tr>";
		...
		strValue +="  <tr>";
		strValue +="   <td ><div align=\"center\"><b>Cities</b></div></td>";
		strValue +="  </tr>";
		strValue +="  </table></TD>";                                                            
		strValue +="  </TR>";
		strValue +="  <TR>";
...
//		////////System.out.println("tempRest>>>>>>>>>"+tempRest);
		...
		if(k==0){
		strValue +=" <A href=\"searchresult.jsp?collCity=&collCategory="+category+"\"><b >ALL</b></A><BR>";
		}
		for(int j=k*10;j<y3;j++){

		strValue +=" <A href=\"searchresult.jsp?collCity="+((Vector)tempCityVec.elementAt(j)).elementAt(0).toString().trim()+"&&collCategory="+category+"\"><b >"+((Vector)tempCityVec.elementAt(j)).elementAt(1).toString().trim()+"</b></A><BR>";
		...
		strValue +="  <tr>";
		strValue +="  <td ><div align=\"center\"><b>Category</b></div></td>";
		strValue +="  </tr>";
		strValue +="  </table> </TD>";
		strValue +=" </TR>";
		strValue +="  <TR>";
...
//		////////System.out.println("tempRest1>>>>>>>>>"+tempRest1);
		...
		strValue +=" <TD colspan=\"2\" align=\"left\" valign=\"top\">";
		if(k2==0){
		strValue +="  <A href=\"searchresult.jsp?collCity=&collCategory=\"></A><BR>";
		}
...
//		////////System.out.println(k+">>>>>>>>>>>>>>>>>>"+tempCityVec.elementAt(j).toString());
		...
		strValue +=" <A href=\"searchresult.jsp?collCity=&collCategory="+tempCat.elementAt(0).toString()+"\"><b >"+tempCat.elementAt(1).toString()+"</b></A><BR>";
		...
		strValue +=" <tr id=\"categorynext\" style=\"display:inline\"><td width=\"60\"></td><td  align=\"right\"  id=\"next\" onclick=\"showCategory(this.id,"+(tempInt2-1)+")\" style=\"cursor:hand\">Next</td></tr>";
		strValue +=" <tr id=\"category\" style=\"display:none\"><td width=\"60\" align=\"center\"  id=\"Previous\" onclick=\"showCategory(this.id,"+(tempInt2-1)+")\" style=\"cursor:hand\">Previous</td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td class=\"bold\"id=\"next\" onclick=\"showCategory(this.id,"+(tempInt2-1)+")\" style=\"cursor:hand\">Next</td></tr>";
		strValue +=" <tr id=\"categorypre\" style=\"display:none\"><td width=\"60\" align=\"left\"  id=\"Previous\" onclick=\"showCategory(this.id,"+(tempInt2-1)+")\" style=\"cursor:hand\">Previous</td><td></td></tr>";


		}}else{
		strValue +=" <tr><td ><b>No Category Availlable</b></A><BR></TD>";
		strValue +=" </TR>";
		}
		strValue +=" </TBODY>";
		strValue +=" </TABLE>";
	...
	{
		String strValue="";
		strValue +=" <TABLE cellSpacing=0 cellPadding=0 width=660 align=center border=0>";
		strValue +="<TBODY>";
		strValue +=" <TR>";
		strValue +=" <TD  bgColor=\"#cccccc\">";
		strValue +=" <TABLE cellSpacing=0 cellPadding=0  align=center bgColor=#ffffff border=0>";
		strValue +=" <TBODY>";
		strValue +=" <TR>";
		strValue +=" <TD >";
...
strValue +="  </tr>";
		...
		if(totalRow>maxVal){
			...
			if(minVal==0){
				...
				strValue +=" <td colspan=\"3\"  align=\"left\"><span style=\"cursor:hand\"  onclick=\"retrieveSComplistURL('searchResult.do?searchFor="+searchFor+"&numMin="+(minVal+maxVal)+"');\" > Next Page</span></td>";
				
			}else if((totalRow - minVal)<= maxVal){
				
				strValue +=" <td colspan=\"3\"  align=\"left\"><span style=\"cursor:hand\"  onclick=\"retrieveSComplistURL('searchResult.do?searchFor="+searchFor+"&numMin="+(minVal-maxVal)+"');\" >Previous Page </span></td>";
				
			}
			else{
			
			strValue +=" <td colspan=\"3\"  align=\"left\"><span style=\"cursor:hand\"  onclick=\"retrieveSComplistURL('searchResult.do?searchFor="+searchFor+"&numMin="+(minVal-maxVal)+"');\" >Previous Page </span> <span style=\"cursor:hand\"  onclick=\"retrieveSComplistURL('searchResult.do?searchFor="+searchFor+"&numMin="+(minVal+maxVal)+"');\" >&nbsp;&nbsp;|&nbsp;&nbsp; Next Page </span></td>";
			}
			strValue +=" </tr>";
		}
		...
		strValue +="  <td height=\"200\" colspan=\"5\" align=\"center\" valign=\"middle\" bgcolor=\"#FFFFFF\"><b >No Company(s) found. </b></td>";
		strValue +="  </tr>";
		strValue +=" <tr align=\"right\" bgcolor=\"#FFFAF6\">";
...
//		////////System.out.println("tempRest>>>>>>>>>"+tempRest);
		...
		strValue +=" <TD colspan=\"2\"  align=\"left\" valign=\"top\">";
		if(k==0){
		strValue +=" <A href=\"searchresult.jsp?comCity=&comCategory="+category+"\"></A><BR>";
		}
		for(int j=k*10;j<y3;j++){

		strValue +=" <A href=\"searchresult.jsp?comCity="+((Vector)tempCityVec.elementAt(j)).elementAt(0).toString().trim()+"&&comCategory="+category+"\"><b >"+((Vector)tempCityVec.elementAt(j)).elementAt(1).toString().trim()+"</b></A><BR>";
...
//		////////System.out.println("tempRest1>>>>>>>>>"+tempRest1);
		...
		strValue +=" <TD colspan=\"2\" align=\"left\" valign=\"top\">";
		if(k2==0){
		strValue +="  <A href=\"searchresult.jsp?comCity=&comCategory=\"></A><BR>";
		}
		for(int j2=k2*10;j2<y2;j2++){
//		////////System.out.println(k+">>>>>>>>>>>>>>>>>>"+tempCityVec.elementAt(j).toString());
		...
		strValue +=" <A href=\"searchresult.jsp?comCity=&comCategory="+tempCat.elementAt(0).toString()+"\"><b >"+tempCat.elementAt(1).toString()+"</b></A><BR>";
		...
		strValue +=" <tr id=\"categorynext\" style=\"display:inline\"><td width=\"60\"></td><td   id=\"next\" onclick=\"showCategory(this.id,"+(tempInt2-1)+")\" style=\"cursor:hand\">Next</td></tr>";
		strValue +=" <tr id=\"category\" style=\"display:none\"><td width=\"60\" align=\"center\" id=\"Previous\" onclick=\"showCategory(this.id,"+(tempInt2-1)+")\" style=\"cursor:hand\">Previous</td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td class=\"bold\"id=\"next\" onclick=\"showCategory(this.id,"+(tempInt2-1)+")\" style=\"cursor:hand\">Next</td></tr>";
		strValue +=" <tr id=\"categorypre\" style=\"display:none\"><td width=\"60\" align=\"left\" id=\"Previous\" onclick=\"showCategory(this.id,"+(tempInt2-1)+")\" style=\"cursor:hand\">Previous</td><td></td></tr>";
	...
	private String getStudentString(String searchFor,DataSource dataSource,Vector complaintVec , String strPageHtml,int numcount,int minVal,int maxVal,int totalRow,String city,String brand, String category,String cityName,String  brandName,int reminder, Vector cscVec, String firstName)
	{
		...
		if(!category.equalsIgnoreCase(""))
		{
			strValue +=" <span class=\"bold\">Course:</span>&nbsp;<b >"+category+"</b>&nbsp;&nbsp;";
		}
		if(!cityName.equalsIgnoreCase(""))
		{
			strValue +=" <span class=\"bold\">city:</span>&nbsp;<b >"+cityName+"</b>&nbsp;&nbsp;";
		}
		if(!firstName.equalsIgnoreCase(""))
		{
			strValue +=" <span class=\"bold\">First Name:</span>&nbsp;<b >"+firstName+"</b>&nbsp;&nbsp;";
		}
		if(!brandName.equalsIgnoreCase(""))
		{
			strValue +=" <span class=\"bold\">College name:</span>&nbsp;<b>"+brandName+"</b>&nbsp;&nbsp;";
		}
		...
		//System.out.println("otherCollId.in action...."+CId);
	...
	strValue +=" <strong><font color=\"#0033FF\"><A href=\"studentResumePre.do?pageid=1&userid="+loginId+"&detailFor=Student\"> "+firstSName+"   "+lastName+"</A></font></strong>,&nbsp;"+tempVec.elementAt(3).toString().trim()+"</td>";
				strValue +=" </tr>";
	...
	strValue +="</td></tr>";
		...
		strValue +=" <tr bgcolor=\"#FFFAF6\">";
		strValue +="  <td height=\"200\" colspan=\"5\" align=\"center\" valign=\"middle\" bgcolor=\"#FFFFFF\"><span >No Student(s) found. </span></td>";
		strValue +="  </tr>";
		strValue +=" <tr align=\"right\" bgcolor=\"#FFFAF6\">";
		strValue +="  <td colspan=\"5\" valign=\"middle\" bgcolor=\"#FFFFFF\"></td>";
		strValue +="  </tr>";
...
//		////////System.out.println("tempRest>>>>>>>>>"+tempRest);
		...
		strValue +=" <A href=\"searchresult.jsp?cityStr="+((Vector)tempCityVec.elementAt(j)).elementAt(0).toString().trim()+"&brandStr="+brand+"&categoryStr="+category+"\"><b >"+((Vector)tempCityVec.elementAt(j)).elementAt(1).toString().trim()+"</b></A><BR>";
		...
		strValue +=" <TD><table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"2\" cellspacing=\"2\" bgcolor=\"#CACACA\">";
		strValue +="  <tr>";
		strValue +="  <td ><div align=\"center\">College</div></td>";
		strValue +="  </tr>";
		strValue +="  </table> </TD>";
		strValue +=" </TR>";
		strValue +="  <TR>";
...
//		////////System.out.println(k+">>>>>>>>>>>>>>>>>>"+tempCityVec.elementAt(j).toString());
		...
		strValue +=" <TD><table width=\"98%\" border=\"0\" align=\"center\" cellpadding=\"2\" cellspacing=\"2\" bgcolor=\"#CACACA\">";
		strValue +="  <tr>";
		strValue +="    <td ><div align=\"center\">Stream</div></td>";
		strValue +="  </tr>";
		strValue +=" </table></TD>";
		strValue +=" </TR>";
		strValue +=" <TR>";
...
//		////////System.out.println(k+">>>>>>>>>>>>>>>>>>"+tempCityVec.elementAt(j).toString());
		...
		strValue +=" <tr><td ><b>No Streem Availlable</b></A><BR></TD>";
		strValue +=" </TR>";
		}
		if(reminder==0)
		{
	...
	private String getPages(int minVal, int maxVal, int numSize, String searchFor)
	{
		String strResult ="<select name=\"paging\" onchange=\"retrieveSComplistURL('searchResult.do?searchFor="+searchFor+"&'+this.value);\">";
		int numMin = 0;
		int numPage = 1;
