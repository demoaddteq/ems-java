...
public class SearchCountryAction extends Action {
	 ...
	 * onchange=\"retrieveSearchStateURL('searchState.do?country='+this.value)\">";
	 */
	...
	{
		String strResult ="<select name=\"country\" tabindex=\"5\" onchange=\"retrieveSearchStateURL('searchState.do?country='+this.value)\">";
