...
public class CategoryAction extends Action {
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		Vector categoryVec = rootMaster.getCategories(getDataSource(request, "main"));
	...
	{
		String strResult ="<select name=\"companyTemplate\" multiple=\"true\"  tabindex=\"15\" onchange=\"outputSelected(this.form.companyTemplate)\">";
