...
public class BrandAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		Vector brandVec = rootMaster.getBrand(getDataSource(request, "main"),numCatId);
	...
	{
		String strResult ="<select name=\"brand\" tabindex=\"6\" onchange=\"retrieveContPerURL('contPerson.do?category="+numCatId+"&brand='+this.value), setBrand()\">";
