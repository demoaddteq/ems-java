...
public class SearchStudentResultAction extends Action{
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		System.out.println("dc in session"+session.getAttribute("searchDataVec"));
		...
		if(paramVec.elementAt(3).equalsIgnoreCase("Student") ){
			 ...
			 searchResultVec = indvMaster.getQuerisResultList(getDataSource(request, "main"), paramVec);
			  totalRow = indvMaster.getQuerisResultCount(getDataSource(request, "main"), paramVec);
			  strDes = "Student";
			 ...
			 searchResultVec = indvMaster.getQuerisResultComList(getDataSource(request, "main"), paramVec);
			 totalRow = indvMaster.getQuerisResultComCount(getDataSource(request, "main"), paramVec);
			 strDes = "Corporates";
		...
		strComplaints = getresultList(getDataSource(request, "main"), strDes, searchResultVec,  strPageHtml, totalRow, minVal, maxVal);
	...
	private String getresultList(DataSource ds, String strDes, Vector searchResultVec, String strPageHtml, int totalRow, int minVal, int maxVal)
	{
		...
		{
			strValue += "<tr >";
			strValue += "<td colspan=\"2\" align=\"right\" class=\"bold\">Results <span > "+minVal1+"</span> - <span >"+maxVal1+"</span> of about <span >"+totalRow+"</span></td>";	
		    ...
		    if(strDes.equalsIgnoreCase("Student")){
				...
				strValue+="<td width=\"20%\" align=\"left\" height=\"20\" class=\"bold\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+j+"</td>";
				...
				strValue+="<td width=\"30%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;<A href=\"studentResumePre.do?pageid=1&userid="+tempVec.elementAt(0).toString()+"&detailFor=Student\"> "+tempVec.elementAt(1).toString()+"&nbsp; "+tempVec.elementAt(2).toString()+"</A></td>";
				strValue+="<td width=\"20%\" align=\"left\" height=\"20\"></td>";
				strValue+="<td width=\"30%\" align=\"left\" height=\"20\"></td>";
				strValue+="<td class=\"bold\">";
				strValue+="</td>";
				...
				strValue+="<td width=\"30%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+tempVec.elementAt(16).toString()+" &nbsp;&nbsp;"+tempVec.elementAt(11).toString()+"</td>";				
				strValue+="<td width=\"20%\" align=\"left\" height=\"20\"></td>";
				...
				strValue+="<td width=\"30%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+tempVec.elementAt(3).toString()+"</td>";
				strValue+="<td width=\"20%\" align=\"left\" height=\"20\"></td>";
				strValue+="<td width=\"30%\" align=\"left\" height=\"20\"></td>";
				strValue+="<td class=\"bold\">";
				strValue+="</td>";
				...
				strValue+="<td width=\"30%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+tempVec.elementAt(6).toString()+"</td>";
				strValue+="<td width=\"20%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;</td>";
				strValue+="<td width=\"30%\" align=\"left\" height=\"20\"></td>";
				strValue+="<td class=\"bold\">";
				strValue+="</td>";
				...
				strValue+="<td width=\"30%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+tempVec.elementAt(10).toString()+"</td>";
				strValue+="<td class=\"bold\">";
				strValue+="</td>";
				strValue+="</tr>";
		    ...
		    else if(strDes.equalsIgnoreCase("Consultants"))
		    {
				...
				strValue+="<td width=\"30%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;<A href=\"detailAll.jsp?pageid=2&cuid="+tempVec.elementAt(0).toString()+"&detailFor=Consultants\">"+tempVec.elementAt(1).toString()+"&nbsp; "+tempVec.elementAt(2).toString()+"</A></td>";
				strValue+="<td width=\"20%\" align=\"left\" height=\"20\"></td>";
				strValue+="<td width=\"30%\" align=\"left\" height=\"20\"></td>";
				strValue+="<td class=\"bold\">";
				strValue+="</td>";
		    ...
		    else if(strDes.equalsIgnoreCase("Corporates"))
		    {
		    	for(int i=0; i< searchResultVec.size(); i++){
					...
					strValue+="<td width=\"30%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;<A href=\"detailAll.jsp?pageid=3&cuid="+tempVec.elementAt(0).toString()+"&detailFor=Corporates\">"+tempVec.elementAt(2).toString()+"&nbsp;</A> </td>";
					strValue+="<td width=\"20%\" align=\"left\" height=\"20\"></td>";
					strValue+="<td width=\"30%\" align=\"left\" height=\"20\"></td>";
					strValue+="<td class=\"bold\">";
					strValue+="</td>";
					...
					/*strValue += "<tr height=\"25\" align=\"center\">";
					strValue+="<td width=\"20%\" align=\"right\" height=\"20\" class=\"bold\">E-mail Id:</td>";
					strValue+="<td width=\"30%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+tempVec.elementAt(9).toString()+"</td>";
					strValue+="<td width=\"20%\" align=\"left\" height=\"20\"></td>";
					strValue+="<td width=\"30%\" align=\"left\" height=\"20\"></td>";
					strValue+="<td class=\"bold\">";
					strValue+="</td>";
					...
					if(tempVec.elementAt(4).toString()!=null){
						strValue+="<td width=\"20%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+tempVec.elementAt(4).toString()+"</td>";
					...
					strValue+="<td width=\"30%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+extraVec.elementAt(2).toString()+"</td>";
					strValue+="<td width=\"20%\" align=\"right\" height=\"20\"class=\"bold\">Pin No:</td>";
					strValue+="<td width=\"30%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+tempVec.elementAt(8).toString()+"</td>";
					strValue+="<td class=\"bold\">";
					strValue+="</td>";
					strValue+="</tr>";
		    ...
		    else if(strDes.equalsIgnoreCase("Advertiser"))
		    {
		    	for(int i=0; i< searchResultVec.size(); i++){
			    	...
			    	strValue += "<tr height=\"25\" align=\"center\">";
					strValue+="<td width=\"20%\" align=\"right\" height=\"20\" class=\"bold\">College Name:  </td>";
					strValue+="<td width=\"30%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;<A href=\"detailAll.jsp?pageid=4&cuid="+tempVec.elementAt(0).toString()+"&detailFor=Advertiser\">"+tempVec.elementAt(2).toString()+"&nbsp;</A> </td>";
					strValue+="<td width=\"20%\" align=\"left\" height=\"20\"></td>";
					strValue+="<td width=\"30%\" align=\"left\" height=\"20\"></td>";
					strValue+="<td >";
					strValue+="</td>";
	...
	{
		String strResult ="<select name=\"paging\" onchange=\"retrieveStudentResultURL('searchStudentResult.do?numCount="+numCount+"&'+this.value);\">";
		int numMin = 0;
		int numPage = 1;
