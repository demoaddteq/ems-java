 ...
 */
public class CollRegisStateAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		{
			strState ="<select name=\"companyState\"  tabindex=\"10\" onchange=\"retrieveCollCityFURL('collRegisCity.do?collcountry="+numCId+"&collstate='+this.value), showOth();\">";
	...
	private String getStateList(int numSid, int numCId, HashMap stateList,int tabindex)
	{
		...
		ArrayList AllStates = (ArrayList)stateList.get(numCId);
			...
			strResult ="<select name=\"companyState\"  tabindex=\""+tabindex+"\" onchange=\"retrieveCollCityFURL('collRegisCity.do?collcountry="+numCId+"&collstate='+this.value), showOth();\">";
