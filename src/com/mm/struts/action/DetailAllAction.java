...
public class DetailAllAction extends Action{
	...
	if(paramVec.elementAt(0).equalsIgnoreCase("Student") ){
		 ...
		 searchResultVec = indvMaster.getUserInfo(getDataSource(request, "main"),Integer.parseInt(paramVec.elementAt(1)));
		 ...
		 searchResultVec = rootMaster.getCompanyDetail(getDataSource(request, "main"),Integer.parseInt(paramVec.elementAt(1)));
		 dataVec.add(cuid);
			Vector tabVec = indvMaster.getTabDetails(getDataSource(request, "main"), dataVec);
	...
	session.setAttribute("strDes", strDes);
	...
	strComplaints = getresultDetail(getDataSource(request, "main"), strDes, searchResultVec);
...
private String getresultDetail(DataSource ds, String strDes, Vector searchResultVec)
{
	...
	else
	{
	    ...
	    if(strDes.equalsIgnoreCase("Student")){
				...
				strValue+="<td width=\"25%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;</td>";
				strValue+="<td width=\"20%\" align=\"left\" height=\"20\"></td>";
				strValue+="<td width=\"25%\" align=\"left\" height=\"20\"><A href=\"otherResumePre.do?userid="+searchResultVec.elementAt(26).toString()+"\">Resume </A> </td>";
			...
			strValue+="<td width=\"25%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+searchResultVec.elementAt(4).toString()+"&nbsp; "+searchResultVec.elementAt(5).toString()+"</td>";
			strValue+="<td width=\"20%\" align=\"left\" height=\"20\"></td>";
			strValue+="<td width=\"25%\" align=\"left\" height=\"20\"></td>";
			strValue+="<td class=\"bold\">";
			strValue+="</td>";
			...
			strValue+="<td width=\"25%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+searchResultVec.elementAt(14).toString()+" </td>";				
			strValue+="<td width=\"20%\" align=\"left\" height=\"20\"></td>";
			strValue+="<td width=\"25%\" class=\"bold\">";
			...
			strValue+="<td width=\"25%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+searchResultVec.elementAt(22).toString()+" </td>";				
			strValue+="<td width=\"20%\" align=\"left\" height=\"20\"></td>";
			strValue+="<td width=\"25%\" class=\"bold\">";
			strValue+="<td align=\"left\" height=\"20\"></td>";
			strValue+="</td>";
			...
			strValue+="<td width=\"25%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+searchResultVec.elementAt(23).toString()+" </td>";				
			strValue+="<td width=\"20%\" align=\"left\" height=\"20\"></td>";
			strValue+="<td width=\"25%\" class=\"bold\">";
			strValue+="<td align=\"left\" height=\"20\"></td>";
			strValue+="</td>";
			...
			strValue+="<td width=\"25%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+searchResultVec.elementAt(24).toString()+" </td>";				
			strValue+="<td width=\"20%\" align=\"left\" height=\"20\"></td>";
			strValue+="<td width=\"25%\" class=\"bold\">";
			strValue+="<td align=\"left\" height=\"20\"></td>";
			strValue+="</td>";
			...
			strValue+="<td width=\"25%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+searchResultVec.elementAt(8).toString()+"</td>";
			strValue+="<td width=\"20%\" align=\"left\" height=\"20\"></td>";
			strValue+="<td width=\"25%\" align=\"left\" height=\"20\"></td>";
			strValue+="<td class=\"bold\">";
			strValue+="</td>";
			...
			strValue+="<td width=\"25%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+searchResultVec.elementAt(9).toString()+"</td>";
			strValue+="<td width=\"20%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;</td>";
			strValue+="<td width=\"25%\" align=\"left\" height=\"20\"></td>";
			strValue+="<td class=\"bold\">";
			strValue+="</td>";
			...
			strValue+="<td width=\"25%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+extraVec.elementAt(0).toString()+"</td>";
			strValue+="<td width=\"20%\" align=\"right\" height=\"20\"class=\"bold\">State:</td>";
			strValue+="<td width=\"25%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+extraVec.elementAt(1).toString()+"</td>";
			strValue+="<td class=\"bold\">";
			strValue+="</td>";
			strValue+="</tr>";
			...
			strValue+="<td width=\"25%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+extraVec.elementAt(2).toString()+"</td>";
			strValue+="<td width=\"20%\" align=\"right\" height=\"20\"class=\"bold\">Pin No:</td>";
			strValue+="<td width=\"25%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+searchResultVec.elementAt(13).toString()+"</td>";
			strValue+="<td class=\"bold\">";
			strValue+="</td>";
			strValue+="</tr>";
			...
			strValue+="<td width=\"25%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+extraVec.elementAt(3).toString()+"</td>";
			strValue+="<td width=\"20%\" align=\"right\" height=\"20\"class=\"bold\">Mobile No:</td>";
			strValue+="<td width=\"25%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+extraVec.elementAt(4).toString()+"</td>";
			strValue+="<td class=\"bold\">";
			strValue+="</td>";
			strValue+="</tr>";
    ...
    */    	
	    ...
	    else if(strDes.equalsIgnoreCase("Corporates"))
	    {
				...
				{ 	
					//System.out.println("strtemCat..........."+strtemCat[m].toString().trim());
					int a = Integer.parseInt(strtemCat[m].toString().trim());
		    	...
		    	strValue+="<tr height=\"25\" align=\"center\">";
				strValue+="<td width=\"25%\" align=\"right\" height=\"20\" class=\"bold\">Company Name:&nbsp;&nbsp;  </td>";
				strValue+="<td width=\"75%\" align=\"left\" height=\"20\" colspan=\"4\">"+searchResultVec.elementAt(1).toString()+"&nbsp; </td>";
				strValue+="</tr>"; 
	...
	*/			
				strValue+="<tr height=\"25\" align=\"center\">";
				strValue+="<td width=\"25%\" align=\"right\" height=\"20\" class=\"bold\">Mentoring Category:&nbsp;&nbsp;  </td>";
				strValue+="<td width=\"75%\" align=\"left\" height=\"20\" colspan=\"4\">"+men1+" </td>";
				strValue+="</tr>"; 
	...
	*/			
				strValue+="<tr height=\"25\" align=\"center\">";
				strValue+="<td width=\"25%\" align=\"right\" height=\"20\" class=\"bold\">Address:&nbsp;&nbsp; </td>";
				strValue+="<td width=\"75%\" align=\"left\" height=\"20\" colspan=\"4\">"+searchResultVec.elementAt(2).toString()+"</td>";
				strValue+="</tr>"; 
				
				if(searchResultVec.elementAt(3).toString()!=null){
				strValue+="<tr height=\"25\" align=\"center\">";
				strValue+="<td width=\"25%\" align=\"right\" height=\"20\" class=\"bold\">&nbsp;&nbsp;</td>";
				strValue+="<td width=\"75%\" align=\"left\" height=\"20\" colspan=\"4\">"+searchResultVec.elementAt(3).toString()+"&nbsp;&nbsp;&nbsp;&nbsp;"+extraVec.elementAt(0).toString()+",&nbsp;&nbsp;"+extraVec.elementAt(1).toString()+",&nbsp;&nbsp;"+extraVec.elementAt(2).toString()+"-&nbsp;&nbsp;"+searchResultVec.elementAt(7).toString()+"</td>";
				strValue+="</tr>";
		...
		/*		strValue+="<tr height=\"25\" align=\"center\">";
				...
				strValue+="<td width=\"25%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+extraVec.elementAt(2).toString()+"</td>";
				strValue+="<td width=\"20%\" align=\"right\" height=\"20\"class=\"bold\"></td>";
				strValue+="<td width=\"25%\" align=\"left\" height=\"20\">&nbsp;&nbsp;&nbsp;&nbsp;"+searchResultVec.elementAt(7).toString()+"</td>";
				strValue+="<td class=\"bold\">";
				strValue+="</td>";
				strValue+="</tr>";
		...
		*/	
	    ...
	    else if(strDes.equalsIgnoreCase("Advertiser"))
	    {
			...
			strValue+="<tr height=\"25\" align=\"center\">";
			strValue+="<td width=\"25%\" align=\"right\" height=\"20\" class=\"bold\">College Name:&nbsp;&nbsp;  </td>";
			strValue+="<td width=\"75%\" align=\"left\" height=\"20\" colspan=\"4\">"+searchResultVec.elementAt(1).toString()+"&nbsp; </td>";
			strValue+="</tr>"; 
			
			strValue+="<tr height=\"25\" align=\"center\">";
			strValue+="<td width=\"25%\" align=\"right\" height=\"20\" class=\"bold\">Category:&nbsp;&nbsp;  </td>";
			strValue+="<td width=\"75%\" align=\"left\" height=\"20\" colspan=\"4\">"+extraVec.elementAt(4).toString()+" </td>";
			strValue+="</tr>"; 
