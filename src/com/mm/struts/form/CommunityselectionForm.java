 ...
 */
public class CommunityselectionForm extends ValidatorForm {
...
this.manuFacturer = manuFacturer;
	...
	{	
		...
		{
			errors.add("communityselectionForm",new ActionError("errors.resource.match","password" , "retype password"));
		}
		...
		{
			errors.add("communityselectionForm",new ActionError("errors.resource.valid","mobile prefix"));
		}
