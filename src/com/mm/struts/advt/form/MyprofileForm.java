...
private String logoPath ="";
	...
	public ActionErrors validate(ActionMapping mapping, HttpServletRequest req)
	{
		...
		{
			errors.add("advtMyprofileForm",new ActionError("errors.resource.other","country"));
			if(this.otherstate.length()<=0)
			{
				errors.add("advtMyprofileForm",new ActionError("errors.resource.other","state"));
				if(this.othercity.length()<=0)
				{
					errors.add("advtMyprofileForm",new ActionError("errors.resource.other","city"));
				}
			}
		}
		else
