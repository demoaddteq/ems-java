...
import com.mm.struts.advt.form.SearchQueriesForm;
...
public class BrandForCatAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		Vector brandVec = rootMaster.getBrandByCat( getDataSource(request, "advt"), numCatId);
	...
	{
		String strResult ="<select name=\"brand\"  tabindex=\"6\" , setBrand()\">";
