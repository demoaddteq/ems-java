...
import com.mm.struts.advt.form.InboxDeletionForm;
...
public class InboxDeletionAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		{
			paramVec.add(inboxs);
			result = advtMaster.updateInbox(getDataSource(request, "advt"), paramVec);
		}
		...
		Vector advtCountVec = advtMaster.complaintCountAdvt(getDataSource(request, "advt"), dataVec);		
