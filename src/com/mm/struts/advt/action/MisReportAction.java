...
public class MisReportAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		String keyArr[] = {"Received", "Attended", "Closed - Resloved", "Closed - UnResloved", "Managerwise"};
		String SubkeyArr[][] = {
				{"Categorywise","Subcategorywise","Statewise","Citywise"},
				{"Categorywise","Subcategorywise","Statewise","Citywise"},
				{"Categorywise","Subcategorywise","Statewise","Citywise","Time taken"},
				{"Categorywise","Subcategorywise","Statewise","Citywise","Time taken"},				
				{"Received","Attended","Closed -Resolved","Closed - Unresolved","Time taken"}
			   };
		...
		String strresult = getresult(request,field1, field2, field3,date1,date2,compId, uId);
	...
	private String getTableRow(String strKey, String strSubKey, String strDuration,String strTabresult,String strresult, int numTempCount,int field1,int field2,int field3)
	{
		...
		strResult+="</td>";
		strResult+="<td ><input name=\"Submit\" type=\"submit\" class=\"button_submit\" value=\"Search\" /></td>";
		strResult+="</tr>";
		//end duration
	...
	private String getresult(HttpServletRequest request,int field1, int field2, int field3,String date1,String date2,String compId, String uId)
	{
		AdvtMaster advtMaster = new AdvtMaster();
		
		int subCatCount = advtMaster.subCategoryCount(getDataSource(request,"advt"), compId);
		...
		dataVec.add(date2);
		dataVec.add(compId);
		dataVec.add(String.valueOf(subCatCount));	
		dataVec.add(uId);
		
		
		Vector resultVec = advtMaster.getMisReport(getDataSource(request,"advt"), dataVec);
		////System.out.println("resultVec............in Action................"+resultVec);
	...
	private String getFinalResult(Vector resultVec,int field1, int field2, int field3)
	{
		...
		String strResult="<table width=\"100%\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" valign=\"top\">";
		String head1="Category",head2="Sub Category";
		String strWidth = "20%";
		...
		if(resultVec.size()>0)
		{
			...
			strResult+="<td class=\"bold\" align=\"center\" width=\""+strWidth+"\">No. Of Query(s)</td>";
			strResult+="</tr>";
			String tempCat = "";
			String tempcat2 ="";
			String strDate = "";
