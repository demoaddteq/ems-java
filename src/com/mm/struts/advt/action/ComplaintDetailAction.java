...
public class ComplaintDetailAction extends Action {
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		//////////System.out.println("adminFlag..in Action avdt ..Detail......."+adminFlag);lowerSubTag
		...
		String aType = (request.getParameter("aType")!=null) ? request.getParameter("aType").trim() : "3";
		session.setAttribute("pgtyp",strPgType);
		////System.out.println("aType..in Action advt..Detail......."+aType);
	...
	//	    	-------------------------
				...
				//////////System.out.println("Pages "+strDetailHtml);
		    	Vector complaintVec = advtMaster.getComplaintDetails(getDataSource(request, "advt"),paramVec2);
...
//		    	complainant Information
		    	...
		    	{
		    		catName=rootMaster.getStrCollegeCategoryName(getDataSource(request, "advt"), cat_id);
		    	}
		    	...
		    	{	
		    		...
		    		strComplaintHtml = getComplaintDetail1(strUnnamed, request,numCompId, strPageHtml, complaintVec, brandVec, complainantVec, delareVec,responseVec, infoVec,pageid,  strShortBy, remander,commentVec, lowerSubTag);
		    	}else
		    	{	
		    		////System.out.println("in else, .....");
		    		strComplaintHtml = getComplaintDetail(strUnnamed, request,numCompId, strPageHtml, complaintVec, brandVec, complainantVec, delareVec,responseVec, infoVec,pageid,  strShortBy, remander,commentVec, lowerSubTag);	
		    	}
	...
	//////////////////////////////////////////////////////////////////////////////
	private String getComplaintDetail1(String strUnnamed, HttpServletRequest request, String numCompId,String strPageHtml,Vector complaintVec,Vector brandVec,Vector complainantVec,Vector delareVec ,Vector responseVec, Vector infoVec,String pageid, String strShortBy, int remander,Vector commentVec, String lowerSubTag)
	{
		...
		String strDetailHtml ="";
			...
			strDetailHtml+="<tr><td colspan=\"2\"><table width=\"100%\">";
	        	 ...
	        	 strDetailHtml+="<tr >";
				   ...
				   strDetailHtml+="<td valign=\"top\" width=\"23%\"><div align=\"right\" class=\"bold\" > From:</div></td>";
				   strDetailHtml+="<td valign=\"top\" width=\"1%\">&nbsp;</td>";
	        ...
	        strDetailHtml+="<tr >";
			   strDetailHtml+="<td valign=\"top\" width=\"1%\">&nbsp;</td>";
			   strDetailHtml+="<td valign=\"top\" width=\"23%\"><div align=\"right\" class=\"bold\" > Request Title:</div></td>";
			   strDetailHtml+="<td valign=\"top\" width=\"1%\">&nbsp;</td>";
			 ...
			 strDetailHtml+="<tr >";
			   strDetailHtml+="<td valign=\"top\" width=\"1%\">&nbsp;</td>";
			   strDetailHtml+="<td valign=\"top\" width=\"23%\"><div align=\"right\" class=\"bold\" > Request ID:</div></td>";
			   strDetailHtml+="<td valign=\"top\" width=\"1%\">&nbsp;</td>";
			 ...
			 strDetailHtml+="<tr >";
			   strDetailHtml+="<td valign=\"top\" width=\"1%\">&nbsp;</td>";
			   strDetailHtml+="<td valign=\"top\" width=\"23%\"><div align=\"right\" class=\"bold\" > Request Originated Date:</div></td>";
			   strDetailHtml+="<td valign=\"top\" width=\"1%\">&nbsp;</td>";
			 ...
			 strDetailHtml+="<tr >";
			   strDetailHtml+="<td valign=\"top\" width=\"1%\">&nbsp;</td>";
			   strDetailHtml+="<td valign=\"top\" width=\"23%\"><div align=\"right\" class=\"bold\" > Category:</div></td>";
			   strDetailHtml+="<td valign=\"top\" width=\"1%\">&nbsp;</td>";
			   strDetailHtml+="<td valign=\"top\" width=\"74%\"><div align=\"justify\"  valign=\"top\">"+infoVec.elementAt(0).toString().trim()+"</div></td>";
			   strDetailHtml+="<td valign=\"top\" width=\"1%\">&nbsp;</td>";
			 strDetailHtml+="</tr>";
		        
		        String cid= complaintVec.elementAt(0).toString().trim();
		        
		        Vector status= indvMaster.getProcessedList(getDataSource(request, "advt"),cid);
		       
		       //////////System.out.println("statusstatusstatusstatus>>>>>>>>"+complaintVec);
		        String strFstatus="UnderProcess";
		        String strSt="";
		        ...
		        if(status.size()!=0){
		 			...
		 			{
		        		 Vector temp = (Vector)status.elementAt(i);
		        		  strSt=temp.elementAt(5).toString().trim();
		 			}
		        	 if(strSt.equalsIgnoreCase("1"))
		        	 {
		        		 strFstatus="Accepted";
		        	 }else
		        	 {
		        ...
		        strDetailHtml+="<tr >";
				   strDetailHtml+="<td valign=\"top\" width=\"1%\">&nbsp;</td>";
				   strDetailHtml+="<td valign=\"top\" width=\"23%\"><div align=\"right\" class=\"bold\" > Status:</div></td>";
				   strDetailHtml+="<td valign=\"top\" width=\"1%\">&nbsp;</td>";
				   strDetailHtml+="<td valign=\"top\" width=\"74%\"><div align=\"justify\"  valign=\"top\">"+strFstatus+"</div></td>";
				   strDetailHtml+="<td valign=\"top\" width=\"1%\">&nbsp;</td>";
				 strDetailHtml+="</tr>";
        ...
        strDetailHtml+="<table width=\"100%\" border=\"0\" valign=\"top\">";
        String strFMsgcompl = "";
        ...
        strDetailHtml+="<tr height=\"60\">";
		   strDetailHtml+="<td valign=\"top\" width=\"1%\">&nbsp;</td>";
		   strDetailHtml+="<td valign=\"top\" width=\"23%\"><div align=\"right\" class=\"bold\" > Request Text: </div></td>";
		   strDetailHtml+="<td valign=\"top\" width=\"1%\">&nbsp;</td>";
		 ...
		 strDetailHtml+="</tr>";
		    strDetailHtml+="</table>";
			  // End td for additional detail
			  	int uid=Integer.parseInt(complaintVec.elementAt(11).toString());
			  	//////////System.out.println("uiduiduiduiduiduiduid>>>>>>>>>>"+uid);
			  	int reqCount= indvMaster.getMentorTotalCount(getDataSource(request, "advt"),uid);
			  	//////////System.out.println("reqCountreqCountreqCountreqCount>>>>>>>>>>"+reqCount);
			  
			
		        
				strDetailHtml+="<tr id=\"row\" style=\"display:none\">";
				strDetailHtml+="<td>";
		        ...
		        if(!(pageid.equals("5") || pageid.equals("6")))
		        {
						...
						strDetailHtml +="<tr height=\"\" id=\"resp\" style=\"display:none\">";
						strDetailHtml +="<td colspan=\"2\"  align=\"left\" class=\"bold\"> Number Of Response By </td>";
						strDetailHtml +="</tr>";
						strDetailHtml +="<tr align=\"left\" valign=\"top\" id=\"resp\" style=\"display:none\" >";
						...
						if(brandresponse==0)
						{
							strDetailHtml +="<tr id=\"resp\" style=\"display:none\">";
							
							strDetailHtml +="</tr>";
							strDetailHtml += "<tr align=\"left\" id=\"resp\"  style=\"display:none\">";
					        ...
					        strDetailHtml += "</tr>";
					        strDetailHtml +="<tr id=\"resp\" >";
							strDetailHtml +="<td colspan=\"2\" align=\"right\" class=\"bold\"><hr color=\"#C1C1C1\"></td>";
							strDetailHtml +="</tr>";
						}else
						{
							
							strDetailHtml += "<tr align=\"left\" style=\"display:none\">";
					        strDetailHtml += "<td colspan=\"2\" valign=\"top\" align=\"left\" ><img id=\""+z+"\" onclick=\"showAddNew("+z+")\" style=\"cursor:hand\" src=\"../images/giveresponse.gif\" width=\"63\" height=\"19\" border=\"0\" alt=\"Click here to give response\"></img></td>";
					        strDetailHtml += "</tr>";
					        strDetailHtml +="<tr>";
							strDetailHtml +="<td colspan=\"2\" align=\"right\" class=\"bold\"><hr color=\"#C1C1C1\"></td>";
					...
					strDetailHtml+="</tr>";
					String accept=(request.getParameter("temp")!=null) ? request.getParameter("temp").trim() : "";
					//////System.out.println("acceptacceptacceptin cpd res form "+accept);
					strDetailHtml+="<tr id=\"rowid"+z+"\" align=\"center\" style=\"display:none\">";
					strDetailHtml+="<td valign=\"top\" colspan=\"2\"><form id=\""+z+"\" name=\"frmreply\" method=\"post\" action=\"mentorReqResponse.do\" >";
					...
					strDetailHtml+=" <input type=\"hidden\" name=\"flag\" id=\"flag\" value=\"\" >";
					strDetailHtml+=" </td>";
					strDetailHtml+="  </tr>";
					...
					strDetailHtml+="<input type=\"hidden\" name=\"accept\" value=\""+accept+"\">";
		        		...
		        		strDetailHtml+="  </tr>";	
		        		strDetailHtml+="<tr id=\"hidecomm\" style=\"display:none\">";
						strDetailHtml+=" <td colspan=\"4\" ><input name=\"flagforcom\" type=\"checkbox\" id=\"communication\" value=\"1\"  > To block this person for future request,please Tick the checkbox.</td>";
		        		strDetailHtml+="  </tr>";	
		        ...
		        if(!(pageid.equals("5") || pageid.equals("6")))
		        {
					...
					if(responseVec.size()>0)
					{
						...
						for(int i=0;i<responseVec.size();i++)
						{
							...
							String strFMsg3 = "";
							//////////System.out.println("comp_type....dc...."+comp_type);
						...
						strDetailHtml+="</tr>";
			        		...
			        		strDetailHtml+="</tr>";
			        		strDetailHtml+="<tr id=\"rowid"+z+"\" align=\"center\" style=\"display:none\">";
			        		strDetailHtml+="<td valign=\"top\" colspan=\"4\"><form id=\""+z+"\" name=\"frmreply\" method=\"post\" action=\"mentorReqResponse.do\" >";
			        		strDetailHtml+="<table width=\"100%\"  border=\"0\" cellspacing=\"0\" cellpadding=\"0\">";
			        		strDetailHtml+="<tr>";
						...
						strDetailHtml+="<tr id=\"hide\" style=\"display:inline\" >";
						strDetailHtml+="<td align=\"center\" colspan=\"3\"><input name=\"accept\"  type=\"button\"   value=\"Accept\" onclick=\"showAddNew2(1)\" >&nbsp;&nbsp;&nbsp;";
						strDetailHtml+="<input name=\"accept\" type=\"button\"    value=\"Reject\" onclick=\"showAddNew2(0)\">&nbsp;&nbsp;&nbsp;<input name=\"accept\" type=\"button\"     value=\"Back\" onclick=\"back()\"></td>";
						strDetailHtml+="</tr>";
						}else
						{
							strDetailHtml+="<tr  style=\"display:inline\"  >";
							strDetailHtml+="<td align=\"center\" colspan=\"3\" class=\"bold\" > This Person already Mentored By 3 Person";
							strDetailHtml+="</td>";
							strDetailHtml+="</tr>";
							strDetailHtml+="<tr>";
							strDetailHtml+="<td align=\"center\" colspan=\"3\" class=\"bold\" > ";
							strDetailHtml+="</td>";
							strDetailHtml+="</tr>";
						
							strDetailHtml+="<tr >";
							strDetailHtml+="<td align=\"center\" colspan=\"3\">";
							strDetailHtml+="<input name=\"back\" type=\"button\"    value=\"Back\" onclick=\"back()\"></td>";
							strDetailHtml+="</tr>";
						}
...
//////////////////////////////////////////////////////////////////////////////
	private String getComplaintDetail(String strUnnamed, HttpServletRequest request, String numCompId,String strPageHtml,Vector complaintVec,Vector brandVec,Vector complainantVec,Vector delareVec ,Vector responseVec, Vector infoVec,String pageid, String strShortBy, int remander,Vector commentVec, String lowerSubTag)
	{
		...
		String strDetailHtml ="";
		  	...
		  	strDetailHtml+="<tr width=\"100%\" valign=\"top\">";
			  //////////////////////////// start td for complaint detail
				strDetailHtml+="<td colspan=\"2\" width=\"100%\" valign=\"top\">";
		  ...
		  //////////////////////////// start td for complaint detail
	        ...
	        strDetailHtml+="<tr height=\"60\">";
			 ...
			 strDetailHtml+="</tr>";
			  	...
			  	strDetailHtml += "<tr align=\"left\" height=\"5\" valign=\"top\">";
		        strDetailHtml += "<td colspan=\"2\"  height=\"5\" valign=\"top\"><hr color=\"#C1C1C1\"></td>";
		        strDetailHtml += "</tr>";
						  ...
						  if(commentVec.size()>0)
							{
						        ...
						        strDetailHtml += "<tr align=\"left\" >";
						        strDetailHtml += "<td width=\"35%\" align=\"left\"class=\"bold\" >&nbsp; Comments:</td>";
								...
								for(int i=0;i<commentVec.size();i++)
								{
									...
									{ 
										...
										strDetailHtml += "<tr align=\"left\" bgcolor=\"#BBF3E4\" height=\"25\" >";
										strDetailHtml+="<td width=\"39%\" align=\"left\" class=\"bold\" >&nbsp;Comment By  :<span >"+fname+" "+lname+"</span></td>";
										strDetailHtml+="<td align=\"center\" width=\"60%\" class=\"bold\">&nbsp;Date:<span >"+respDate+"</span></td>";
								        strDetailHtml += "</tr>";
								        
								        strDetailHtml += "<tr align=\"left\" bgcolor=\"#FFFAF6\" >";
										strDetailHtml+="<td  align=\"left\" colspan=\"2\" class=\"bold\" valign=\"top\" >";
										strDetailHtml+="<table valign=\"top\" height=\"45\">";
										strDetailHtml+="<tr>";
										strDetailHtml+="<td  width=\"13%\"class=\"bold\" valign=\"top\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Text:";
										strDetailHtml+="</td>";
										strDetailHtml+="<td  valign=\"top\">"+strFMsg3+"</td>";
										strDetailHtml+="</tr>";
										strDetailHtml+="</table>";
										strDetailHtml+="</td>";
								        strDetailHtml += "</tr>";
	...
	{
		String strResult ="<select name=\"paging\" onchange=\"retrieveAdvtCompDetailURL('complaintDetail.do?'+this.value);\">";
		int numMin = 0;
		int numPage = 1;
