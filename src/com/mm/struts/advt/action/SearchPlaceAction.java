...
public class SearchPlaceAction extends Action {
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		if(!codeStrArr[0].equalsIgnoreCase("-1"))
		{
			 ...
			 * Country Start Here
			 */
			Vector CountryVec = rootMaster.getCountries(getDataSource(request,"advt"));
			...
			else
			{
				...
				else
				{
				     ...
				     * State Start Here
				     */
				    Vector StateVec = rootMaster.getState(numCId, getDataSource(request, "advt"));
				    ...
				    else
				    {
						...
						{				
							...
							{
								Vector placeVec = rootMaster.getPlace(numCId, numSId, getDataSource(request, "advt"));
