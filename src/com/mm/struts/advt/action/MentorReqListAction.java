...
//		//System.out.println("compId..in Action avdt ........."+compId);
	   ...
	   //System.out.println("strFShortBy........."+strFShortBy);
		...
		if(pageid.equalsIgnoreCase("1")&& lowerSubTag.equalsIgnoreCase("1")){
			comVec = advtMaster.getUnderprocessList1(getDataSource(request, "advt"),Cid,Uid,aFid);
		...
		paramVec.add(lowerSubTag);
				...
				totalRow = advtMaster.getMentoringReqCount(getDataSource(request, "advt"), paramVec1);
				userVec= advtMaster.getMentoringReqList(getDataSource(request, "advt"), paramVec);
