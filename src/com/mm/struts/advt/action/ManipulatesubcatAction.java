...
//			Page Id
	...
	//		Category Id
			...
			{
				target = am.setSubCategory(mscf, getDataSource(request, "advt"), Integer.parseInt(strCompId.trim()));
			}
			else if(strCmdVal.equalsIgnoreCase("Modify"))
			{
				target = am.editSubCategory(mscf, getDataSource(request, "advt"), Integer.parseInt(strCompId.trim()));
			}
			else if(strCmdVal.equalsIgnoreCase("Delete"))
			{
				target = am.deleteSubCategory(mscf, getDataSource(request, "advt"), Integer.parseInt(strCompId.trim()));
			}
			else
			{
				target = "failure";
