...
public class AdvtUserdetailAction extends Action {
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		Vector userVec = ob.getUserInfo(getDataSource(request, "advt"), userid);
		////System.out.println("userVec..........."+userVec);
		int UserCityId = Integer.parseInt(userVec.elementAt(6).toString().trim());
    	String UserCityname = ob.getPlaceName(getDataSource(request, "advt"), UserCityId);		    	
    	int UserStateId = Integer.parseInt(userVec.elementAt(7).toString().trim());
    	String UserStateName = ob.getStateName(getDataSource(request, "advt"), UserStateId);		    	
    	int UserCountryId = Integer.parseInt(userVec.elementAt(11).toString().trim());
    	String UserCountryname = ob.getCountryName(getDataSource(request, "advt"), UserCountryId);
    	int numRId = Integer.parseInt(userVec.elementAt(1).toString().trim());
    	Vector userRightVec = am.getUserGroupDetails(getDataSource(request, "advt"), Integer.parseInt(compId.trim()), numRId, "Details");
    	int dep_Id = Integer.parseInt(userVec.elementAt(19).toString());
		int des_Id = Integer.parseInt(userVec.elementAt(20).toString());
		String desStr = ob.getDesName(getDataSource(request, "advt"),des_Id);	
		String depStr = ob.getDepName(getDataSource(request, "advt"),dep_Id);
    	...
    	//////System.out.println("userid "+userid);
    	Vector userCategoryVec = am.getUserCategoryDetails(getDataSource(request, "advt"), Integer.parseInt(compId.trim()), userid);
    	...
    	for(int i=0; i<userCategoryVec.size(); i++)
    	{
    		...
    		if(Integer.parseInt(userCategoryVec.elementAt(i).toString().trim())==0)
    		{
    			...
    			String strCatVal = "";
    			if(i>0){
    			 strCatVal = am.getSubCatDetail(getDataSource(request, "advt"), Integer.parseInt(compId.trim()), Integer.parseInt(userCategoryVec.elementAt(i-1).toString().trim()), i-1);
    			}
    			userCatVec.add(strCatVal);
    			String strCatVal1 = "";
    			String strAdminName  = "";
    			if(i>1){
    			 strCatVal1 = am.getSubCatDetail(getDataSource(request, "advt"), Integer.parseInt(compId.trim()), Integer.parseInt(userCategoryVec.elementAt(i-2).toString().trim()), i-2);
    			int numCatVal = Integer.parseInt(userCategoryVec.elementAt(i-2).toString().trim());
    			
    			userCatVec.add(strCatVal1);
    			 strAdminName = am.getAdminName(getDataSource(request, "advt"), Integer.parseInt(compId.trim()), numCatVal, i-2);
    			}
	...
	private String getUserDetail( Vector userVec,Vector infoVec, int minVal, String strPageHtml, int remander, Vector userRightVec, Vector userCatVec)
	{
		...
		{	
			...
			strValue += "<table width=\"100%\" align=\"center\"  >";
			strValue += "<tr>";
			strValue += "<td colspan=\"2\" align=\"center\" valign=\"top\" class=\"bold\">";
			...
			strValue += " <tr height=\"20\">";
			strValue += "  <td  align=\"right\" class=\"bold\">Login Name:</td>";
			...
			*/
			...
			System.out.println("cxcxcxcxzcxzcc"+userVec.elementAt(17).toString().length());
			String strmen1 = "NO";
			String strque1 = "NO";
			
			if(strMentoring.length>=0){
			...
			strValue += " <tr height=\"20\">";
			strValue += "  <td align=\"right\" class=\"bold\"> Mentoring In:</td>";
			strValue += " <td align=\"left\"><span >"+strmen1+"</span></td>";
			strValue += "  </tr>";
			
			strValue += " <tr height=\"20\">";
			strValue += "  <td align=\"right\" class=\"bold\"> Queries In:</td>";
			strValue += " <td align=\"left\"><span >"+strque1+"</span></td>";
			strValue += "  </tr>";
			...
			if(userRightVec.size()==0){
				...
				strValue += "<tr>";
				strValue += "<td colspan=\"2\" align=\"left\" class=\"bold\">&nbsp;&nbsp;<span class=\"bold\"><u>You Have All Rights</u></span></td>";
				strValue += "</tr>";
				...
				strValue += "<tr>";
				strValue += "<td width=\"20%\" align=\"right\" class=\"bold\">&nbsp;</td>";
				strValue += "<td width=\"80%\" align=\"left\"><span >&nbsp;Test Creation</span></td>";
				strValue += "</tr>";
				
				strValue += "<tr>";
				strValue += "<td width=\"20%\" align=\"right\" class=\"bold\">&nbsp;</td>";
				strValue += "<td width=\"80%\" align=\"left\"><span >&nbsp;Mentoring</span></td>";
				strValue += "</tr>";
				
				strValue += "<tr>";
				strValue += "<td width=\"20%\" align=\"right\" class=\"bold\">&nbsp;</td>";
				strValue += "<td width=\"80%\" align=\"left\"><span >&nbsp;Queries Allotment</span></td>";
				strValue += "</tr>";
				
				strValue += "<tr>";
				strValue += "<td width=\"20%\" align=\"right\" class=\"bold\">&nbsp;</td>";
				strValue += "<td width=\"80%\" align=\"left\"><span >&nbsp;MIS</span></td>";
				strValue += "</tr>";
				
				strValue += "<tr>";
				strValue += "<td width=\"20%\" align=\"right\" class=\"bold\">&nbsp;</td>";
				strValue += "<td width=\"80%\" align=\"left\"><span >&nbsp;Queries Management</span></td>";
				strValue += "</tr>";
			...
			if(userRightVec.size()>=13)
			{
				...
				*/
				...
				if(Integer.parseInt(userRightVec.elementAt(8).toString().trim())==1)
				{
					strValue += "<tr>";
					strValue += "<td width=\"20%\" align=\"right\" class=\"bold\">&nbsp;</td>";
					strValue += "<td width=\"80%\" align=\"left\"><span >&nbsp;Complaint Management</span></td>";
					strValue += "</tr>";
				}
			...
			if(userCatVec.size()>=3)
			{
				...
				strValue +="</tr>";
				strValue +="<tr>";
				strValue +="<td colspan=\"2\" align=\"left\" class=\"bold\">";
				strValue += "<table width=\"100%\" align=\"center\"  >";				
				strValue += "<tr>";
				strValue += "<td colspan=\"2\" align=\"left\" class=\"bold\"><u>Work Category</u>&nbsp;</td>";
				strValue += "</tr>";
				//userCatVec
				strValue += "<tr>";
				strValue += "<td width=\"40%\" align=\"right\" class=\"bold\">Admin Category&nbsp;</td>";
				strValue += "<td width=\"60%\" align=\"left\"><span >&nbsp;"+userCatVec.elementAt(1).toString().trim()+"</span></td>";
				strValue += "</tr>";
				if(!userCatVec.elementAt(2).toString().trim().equalsIgnoreCase(""))
				{
					strValue += "<tr>";
					strValue += "<td width=\"40%\" align=\"right\" class=\"bold\">Admin Name&nbsp;</td>";
					strValue += "<td width=\"60%\" align=\"left\"><span >&nbsp;"+userCatVec.elementAt(2).toString().trim()+"</span></td>";
					strValue += "</tr>";
				}
				strValue += "<tr>";
				strValue += "<td width=\"40%\" align=\"right\" class=\"bold\">Your Category&nbsp;</td>";
				strValue += "<td width=\"60%\" align=\"left\"><span >&nbsp;"+userCatVec.elementAt(0).toString().trim()+"</span></td>";
				strValue += "</tr>";
				strValue += " </table>";
				strValue +="</td></tr>";
