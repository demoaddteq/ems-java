...
public class SearchQueriesResultAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if(searchFor.equalsIgnoreCase("0")){
			...
			strComplaints = getStudentString(searchFor, dataSource,complaintVec,strPageHtml,numcount,minVal,maxVal,totalRow, city, brand,  categoryName, cityName, brandName, reminder, cscVec, firstName);
		 ...
		 */
			...
			// //////////System.out.println("paramVec>>>>>>>Corporates>>>>>>>"+paramVec);
				...
				int numcount = complaintVec.size();
				strComplaints = getCompanyString(searchFor,dataSource,complaintVec,strPageHtml,numcount,minVal,maxVal,totalRow,cscVec, category,categoryName, cityName, firstName);
		 ...
		 */
			...
			// //////////System.out.println("searchVec>>>>>>>3>>>>>>>"+searchVec);
			 ...
			 ////////////System.out.println("paramVec>>>>>>>3>>>>>>>"+paramVec);
				...
				int numcount = complaintVec.size();
				strComplaints = getCollegeString(searchFor, dataSource,complaintVec,strPageHtml,numcount,minVal,maxVal,totalRow,cscVec, category,categoryName, cityName, firstName);
	...
	private String getCollegeString(String searchFor, DataSource dataSource,Vector complaintVec , String strPageHtml,int numcount,int minVal,int maxVal,int totalRow, Vector cscVec,String category,String categoryName,String cityName, String firstName)
	{
		String strValue="";
		...
		strValue +="   <TBODY>";
		strValue +="   <TR>";
		strValue +=" <TD align=\"center\" valign=\"top\" width=\"100%\"><TABLE   width=\"100%\" border=0 align=\"center\" cellPadding=0 cellSpacing=0>";
		strValue +="  <TBODY>";
		strValue +=" <tr >";
		strValue +="   <TD  bgcolor=\"#FFFFFF\" class=\"bold\"><a href=\"searchQueries.jsp?searchFor="+searchFor+"\" class=\"Arial_Narrow_12_blue_normal style10\">Click here to New search</a></TD>";
...
strValue +=" <tr align=\"right\" height=\"20\">";
	strValue +="  <td colspan=\"5\" width=100% valign=\"middle\" >";
			strValue +="<table width=100% bgcolor=\""+strColor+"\" >";
				...
				//strValue +="<td width=\"20%\" bgcolor=\""+strColor+"\" ></td>";
					...
					strValue +="  <td colspan=\"5\" valign=\"top\"  bgcolor=\""+strColor+"\" >&nbsp;";
								...
								strValue +=" </tr>";
								strValue +=" <tr align=\"left\" valign=\"bottom\" >";
								strValue +="  <td colspan=\"5\" valign=\"top\"   >&nbsp;";
...
////////////////////////////////////td///for Cities//////////////////////
		...
		strValue +="  <TABLE  cellSpacing=0 cellPadding=0  align=right bgColor=#ffffff border=1 >";
		strValue +=" <TBODY>";
		strValue +=" <TR>";
		strValue +=" <TD >";
		strValue +=" <TABLE cellSpacing=0 cellPadding=0 align=center border=0>";
		strValue +=" <TBODY>";
		strValue +=" <TR>";
		strValue +=" <TD ><TABLE cellSpacing=0 cellPadding=0  border=0>";
		strValue +=" <TBODY>";
		strValue +="  <TR>";
		strValue +=" <TD background=blogs_files/1x1white.gif></TD></TR>";
		strValue +="  <TR>";
		strValue +=" <TD><table  border=\"0\" align=\"center\" cellpadding=\"2\" cellspacing=\"2\" bgcolor=\"#CACACA\">";
		strValue +="  <tr>";
...
//		//////////System.out.println("tempRest>>>>>>>>>"+tempRest);
		...
		strValue +=" <tr id=\"citynext\" style=\"display:inline\"><td ></td><td  align=\"right\" class=\"bold\" id=\"next\" onclick=\"showCity(this.id,"+(tempInt-1)+")\" style=\"cursor:hand\">Next</td></tr>";
		strValue +=" <tr id=\"city\" style=\"display:none\"><td  align=\"center\" class=\"bold\" id=\"Previous\" onclick=\"showCity(this.id,"+(tempInt-1)+")\" style=\"cursor:hand\">Previous&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td class=\"bold\" id=\"next\" onclick=\"showCity(this.id,"+(tempInt-1)+")\" style=\"cursor:hand\">Next</td></tr>";
		strValue +=" <tr id=\"citypre\" style=\"display:none\"><td colspan=\"2\" align=\"left\" class=\"bold\" id=\"Previous\" onclick=\"showCity(this.id,"+(tempInt-1)+")\" style=\"cursor:hand\">Previous</a></td><td></td></tr>";
		...
		strValue +=" <TR><TD>";
		strValue +=" <TABLE cellSpacing=0 cellPadding=0  border=0>";
		strValue +=" <TBODY>";
		strValue +="  <TR>";
		strValue +=" <TD background=blogs_files/1x1white.gif>";
		strValue +=" </TD></TR>";
...
//		//////////System.out.println(k+">>>>>>>>>>>>>>>>>>"+tempCityVec.elementAt(j).toString());
		...
		strValue +=" <tr id=\"categorynext\" style=\"display:inline\"><td ></td><td  align=\"right\" class=\"bold\" id=\"next\" onclick=\"showCategory(this.id,"+(tempInt2-1)+")\" style=\"cursor:hand\">Next</td></tr>";
		strValue +=" <tr id=\"category\" style=\"display:none\"><td  align=\"center\" class=\"bold\" id=\"Previous\" onclick=\"showCategory(this.id,"+(tempInt2-1)+")\" style=\"cursor:hand\">Previous</td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td class=\"bold\" id=\"next\" onclick=\"showCategory(this.id,"+(tempInt2-1)+")\" style=\"cursor:hand\">Next</td></tr>";
		strValue +=" <tr id=\"categorypre\" style=\"display:none\"><td  align=\"left\" class=\"bold\" id=\"Previous\" onclick=\"showCategory(this.id,"+(tempInt2-1)+")\" style=\"cursor:hand\">Previous</td><td></td></tr>";


		}}else{
		strValue +=" <tr><td class=\"bold\">No Category Availlable</A><BR></TD>";
		strValue +=" </TR>";
		}
		strValue +=" </TBODY>";
		strValue +=" </TABLE>";
	...
	private String getCompanyString(String searchFor,DataSource dataSource,Vector complaintVec , String strPageHtml,int numcount,int minVal,int maxVal,int totalRow, Vector cscVec,String category,String categoryName,String cityName, String firstName)
	{
		String strValue="";
		strValue +="  <TABLE  width=\"100%\" border=0 cellPadding=0 cellSpacing=0 >";
		strValue +=" <TBODY width=\"100%\">";
		...
		strValue +="  <TBODY>";
		strValue +=" <tr >";
		strValue +="   <TD width=\"40%\" bgcolor=\"#FFFFFF\" class=\"bold\"><a href=\"searchQueries.jsp?searchFor="+searchFor+"\" class=\"Arial_Narrow_12_blue_normal style10\">Click here to New search</a></TD>";
		...
		strValue +=" <td colspan=\"3\"><hr color=\"#C1C1C1\"></td></tr>";
		strValue +=" <TR>";
		strValue +=" <TD height=\"30\" colspan=\"2\" align=\"left\" valign=\"middle\" class=\"bold\">&nbsp;&nbsp;Search Criteria:&nbsp;&nbsp;";
		if(!category.equalsIgnoreCase(""))
		{
			strValue +=" <span class=\"bold\">Category:</span>&nbsp;<span class=\"bold\">"+categoryName+"</span>&nbsp;&nbsp;";
		}
    	...
    	strValue +="  <td colspan=\"5\" valign=\"middle\" >";
    			strValue +="<table width=\"100%\" bgcolor=\""+strColor+"\" >";
    				...
    				//strValue +="<td width=\"20%\" bgcolor=\""+strColor+"\" ></td>";
    					...
    					strValue +="  <td colspan=\"5\" valign=\"middle\"  bgcolor=\""+strColor+"\" >&nbsp;";
...
//		////////////System.out.println("tempRest>>>>>>>>>"+tempRest);
		...
		strValue +=" <TD colspan=\"2\"  align=\"left\" valign=\"top\">";
		if(k==0){
		strValue +=" <A href=\"searchQueries.jsp?comCity=&comCategory="+category+"\"><SPAN class=\"bold\">ALL</SPAN></A><BR>";
		}
		for(int j=k*10;j<y3;j++){

		strValue +=" <A href=\"searchQueries.jsp?comCity="+((Vector)tempCityVec.elementAt(j)).elementAt(0).toString().trim()+"&&comCategory="+category+"\"><SPAN class=\"bold\">"+((Vector)tempCityVec.elementAt(j)).elementAt(1).toString().trim()+"</SPAN></A><BR>";
...
//		////////////System.out.println("tempRest1>>>>>>>>>"+tempRest1);
		...
		strValue +=" <TD colspan=\"2\" align=\"left\" valign=\"top\">";
		if(k2==0){
		strValue +="  <A href=\"searchQueries.jsp?comCity=&comCategory=\"><SPAN class=\"bold\">ALL</SPAN></A><BR>";
		}
		for(int j2=k2*10;j2<y2;j2++){
//		////////////System.out.println(k+">>>>>>>>>>>>>>>>>>"+tempCityVec.elementAt(j).toString());
		...
		strValue +=" <A href=\"searchQueries.jsp?comCity=&comCategory="+tempCat.elementAt(0).toString()+"\"><SPAN class=\"bold\">"+tempCat.elementAt(1).toString()+"</SPAN></A><BR>";
	...
	private String getStudentString(String searchFor,DataSource dataSource,Vector complaintVec , String strPageHtml,int numcount,int minVal,int maxVal,int totalRow,String city,String brand, String category,String cityName,String  brandName,int reminder, Vector cscVec, String firstName)
	{
		...
		strValue +="<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" bgcolor=\""+strColor+"\">";
			...
			strValue +="<table width=\"100%\"  align=\"center\"  border=\"1\" cellspacing=\"0\" cellpadding=\"0\">";
			strValue +="<tr height=\"125\" align=\"left\" valign=\"middle\" bgcolor=\"#FFFAF6\"><td align=\"center\" valign=\"middle\"><img src =\""+photopath+"\" width=\"80\"  height=\"100\"></img></td>";
			strValue +="</tr>";					
			strValue +="</table>";
			strValue +="</td>";
			*/
				...
				strValue +="<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"  bgcolor=\""+strColor+"\">";				
				strValue +=" <tr align=\"left\" valign=\"middle\">";
				strValue +="  <td colspan=\"5\" valign=\"middle\" height=\"20\" >&nbsp;";
...
//		////////////System.out.println(k+">>>>>>>>>>>>>>>>>>"+tempCityVec.elementAt(j).toString());
		...
		strValue +=" <tr><td class=\"bold\">No College Availlable<BR></TD>";
		strValue +=" </TR>";
		}
		strValue +=" </TBODY>";
		strValue +=" </TABLE>";
...
//		//////////System.out.println(k+">>>>>>>>>>>>>>>>>>"+tempCityVec.elementAt(j).toString());
		...
		strValue +=" <tr><td class=\"bold\">No Streem Availlable</A><BR></TD>";
		strValue +=" </TR>";
		}
		if(reminder==0)
		{
			strValue +=" <tr><td class=\"bold\"><BR></TD>";
			strValue +=" </TR>";
		}
		strValue +=" </TBODY>";
		strValue +=" </TABLE>";
