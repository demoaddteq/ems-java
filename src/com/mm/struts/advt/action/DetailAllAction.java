...
public class DetailAllAction extends Action{
	...
	if(paramVec.elementAt(0).equalsIgnoreCase("Student") ){
		 ...
		 searchResultVec = indvMaster.getUserInfo(getDataSource(request, "advt"),Integer.parseInt(paramVec.elementAt(1)));
		 ...
		 searchResultVec = rootMaster.getCompanyDetail(getDataSource(request, "advt"),Integer.parseInt(paramVec.elementAt(1)));
	...
	strComplaints = getresultDetail(getDataSource(request, "advt"), strDes, searchResultVec);
